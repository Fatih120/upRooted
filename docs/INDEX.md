...
| Obfuscation                | [`docs/framework/OBFUSCATION.md`](framework/OBFUSCATION.md)                             | ConfuserEx2 obfuscation pipeline — protections, protected names, build integration, verification                             | Framework contributors                 |
