...
| Built-in Plugins Index    | [`docs/plugins/builtin/INDEX.md`](plugins/builtin/INDEX.md)                       | Overview of built-in plugins (4 TypeScript + 2 C# hook)                               | Everyone                               |
...
| Message Logger            | [`docs/plugins/builtin/message-logger.md`](plugins/builtin/message-logger.md)     | Logs deleted and edited messages with visual indicators (C# hook, WIP)                | Everyone                               |
