...
1. **Download the installer** from the
   ...
   - Windows: `Uprooted-0.4.0-Setup.exe`
   - Linux: `Uprooted-0.4.0-linux-amd64`
...
3. **Run the installer** from a terminal:
   ...
   .\Uprooted-0.4.0-Setup.exe

   # Linux
   chmod +x Uprooted-0.4.0-linux-amd64
   ./Uprooted-0.4.0-linux-amd64
   ```
...
[HH:MM:SS.fff] [Startup] === Uprooted Hook v0.4.0 Loaded ===
[HH:MM:SS.fff] [Startup] ========================================
...
```bash
# Windows
.\Uprooted-0.4.0-Setup.exe --uninstall

# Linux
./Uprooted-0.4.0-linux-amd64 --uninstall
```
...
```bash
# Windows
.\Uprooted-0.4.0-Setup.exe --repair

# Linux
./Uprooted-0.4.0-linux-amd64 --repair
```
