...
Version: 0.1.95 (package.json) / 0.1.1 (hook display). Target: Root v0.9.86+.
...
**Versions:** package.json 0.1.95 | hook display "0.1.1" | Target Root 0.9.87
...
*Quick-start reference for Uprooted v0.1.95. Last updated 2026-02-16.*
