...
**Uprooted** v0.5.1-dev2 — client mod framework for Root Communications desktop (v0.9.93+).
...
*Quick-start reference for Uprooted v0.5.1-dev2. Last updated 2026-02-23.*
