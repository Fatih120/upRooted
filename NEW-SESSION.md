...
**Uprooted** v0.5.1-dev1 — client mod framework for Root Communications desktop (v0.9.93+).
...
| `AutoUpdater.cs` | 1045 | Encrypted .uprpkg auto-updater |
...
*Quick-start reference for Uprooted v0.5.1-dev1. Last updated 2026-02-23.*
