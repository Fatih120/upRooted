...
Uprooted is not in active development by the original developers and this repo is simply an archive. I'll still accept PRs if anyone wants to get around to anything like that.

It's clear a lot of these documentation files were slopped out thoughever.
...
```bash
git clone https://github.com/Fatih120/upRooted.git
cd uprooted
git checkout main
pnpm install
```
