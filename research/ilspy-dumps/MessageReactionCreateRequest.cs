...
public sealed class MessageReactionCreateRequest : IMessage<MessageReactionCreateRequest>, IMessage, IEquatable<MessageReactionCreateRequest>, IDeepCloneable<MessageReactionCreateRequest>, IBufferMessage
{
	private static readonly MessageParser<MessageReactionCreateRequest> _parser = new MessageParser<MessageReactionCreateRequest>(() => new MessageReactionCreateRequest());
	...
	public static MessageParser<MessageReactionCreateRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public MessageReactionCreateRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public MessageReactionCreateRequest(MessageReactionCreateRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public MessageReactionCreateRequest Clone()
	{
		return new MessageReactionCreateRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as MessageReactionCreateRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(MessageReactionCreateRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(MessageReactionCreateRequest other)
	{
		if (other == null)
		{
			return;
