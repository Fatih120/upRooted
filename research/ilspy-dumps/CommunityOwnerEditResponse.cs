...
public sealed class CommunityOwnerEditResponse : IMessage<CommunityOwnerEditResponse>, IMessage, IEquatable<CommunityOwnerEditResponse>, IDeepCloneable<CommunityOwnerEditResponse>, IBufferMessage
{
	private static readonly MessageParser<CommunityOwnerEditResponse> _parser = new MessageParser<CommunityOwnerEditResponse>(() => new CommunityOwnerEditResponse());
	...
	public static MessageParser<CommunityOwnerEditResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityOwnerEditResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityOwnerEditResponse(CommunityOwnerEditResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityOwnerEditResponse Clone()
	{
		return new CommunityOwnerEditResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityOwnerEditResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityOwnerEditResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityOwnerEditResponse other)
	{
		if (other == null)
		{
			return;
