...
// RootApp.Client.Avalonia.UI.Main.MainWindow
using System;
...
public class MainWindow : Window
{
	...
	{
		CompiledAvaloniaXaml.XamlIlContext.Context<MainWindow> context = new CompiledAvaloniaXaml.XamlIlContext.Context<MainWindow>(P_0, new object[1] { _0021AvaloniaResources.NamespaceInfo_003A_002FUI_002FMain_002FMainWindow_002Eaxaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Main/MainWindow.axaml")
		{
			RootObject = P_1,
		...
		Controls children = dockPanel5.Children;
		...
		CompiledBindingExtension compiledBindingExtension = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp_002EClient_002EAvalonia_002EUI_002EMain_002EMainViewModel_002CRootApp_002EClient_002EAvalonia_002ETitleBarViewModel_0021Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = ContentControl.ContentProperty;
		CompiledBindingExtension compiledBindingExtension2 = compiledBindingExtension.ProvideValue(context);
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters._003C_003EXamlDynamicSetter_4(contentControl5, compiledBindingExtension2);
		DockPanel.SetDock(contentControl5, Dock.Top);
		context.PopParent();
		((ISupportInitialize)contentControl3).EndInit();
		Controls children2 = dockPanel5.Children;
		...
		Controls children3 = dockPanel9.Children;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters._003C_003EXamlDynamicSetter_4(contentControl9, compiledBindingExtension4);
		context.PopParent();
