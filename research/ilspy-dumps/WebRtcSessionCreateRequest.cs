...
public sealed class WebRtcSessionCreateRequest : IMessage<WebRtcSessionCreateRequest>, IMessage, IEquatable<WebRtcSessionCreateRequest>, IDeepCloneable<WebRtcSessionCreateRequest>, IBufferMessage
{
	private static readonly MessageParser<WebRtcSessionCreateRequest> _parser = new MessageParser<WebRtcSessionCreateRequest>(() => new WebRtcSessionCreateRequest());
	...
	public static MessageParser<WebRtcSessionCreateRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public WebRtcSessionCreateRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public WebRtcSessionCreateRequest(WebRtcSessionCreateRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public WebRtcSessionCreateRequest Clone()
	{
		return new WebRtcSessionCreateRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as WebRtcSessionCreateRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(WebRtcSessionCreateRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(WebRtcSessionCreateRequest other)
	{
		if (other == null)
		{
			return;
