...
public class DeleteChannelGroupView : UserControl
{
	[CompilerGenerated]
	private static Action<object> !XamlIlPopulateOverride;

	public DeleteChannelGroupView()
	{
		InitializeComponent();
	}
	...
	[CompilerGenerated]
	private static void !XamlIlPopulate(IServiceProvider P_0, DeleteChannelGroupView P_1)
	{
		CompiledAvaloniaXaml.XamlIlContext.Context<DeleteChannelGroupView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<DeleteChannelGroupView>(P_0, new object[1] { !AvaloniaResources.NamespaceInfo:/UI/Community/Channels/DeleteChannelGroupView.axaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Community/Channels/DeleteChannelGroupView.axaml")
		{
			RootObject = P_1,
		...
		rootConfirmationControl4.TitleText = RootApp.Client.Avalonia.Resources.Strings.Resources.DeleteChannelGroup;
		...
		rootConfirmationControl4.WebApiSendingText = RootApp.Client.Avalonia.Resources.Strings.Resources.DeletingChannelGroup;
		rootConfirmationControl4.WebApiSuccessText = RootApp.Client.Avalonia.Resources.Strings.Resources.SuccessfullyDeletedChannelGroup;
		rootConfirmationControl4.WebApiFailedText = RootApp.Client.Avalonia.Resources.Strings.Resources.FailedToDeleteChannelGroup;
		StyledProperty<WebApiStatus> webApiStatusProperty = RootConfirmationControl.WebApiStatusProperty;
		CompiledBindingExtension compiledBindingExtension6 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Community.Channels.DeleteChannelGroupViewModel,RootApp.Client.Avalonia.WebApiStatus!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
	...
	[CompilerGenerated]
	private static void !XamlIlPopulateTrampoline(DeleteChannelGroupView P_0)
	{
