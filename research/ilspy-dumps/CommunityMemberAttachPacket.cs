...
public sealed class CommunityMemberAttachPacket : IPacketCommunity, IPacket, IMessage<CommunityMemberAttachPacket>, IMessage, IEquatable<CommunityMemberAttachPacket>, IDeepCloneable<CommunityMemberAttachPacket>, IBufferMessage
{
	private static readonly MessageParser<CommunityMemberAttachPacket> _parser = new MessageParser<CommunityMemberAttachPacket>(() => new CommunityMemberAttachPacket());
	...
	public static MessageParser<CommunityMemberAttachPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(CommunityMemberAttachPacket packet)
	{
		return new PacketContainer
		{
			CommunityMemberAttach = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public CommunityMemberAttachPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityMemberAttachPacket(CommunityMemberAttachPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityMemberAttachPacket Clone()
	{
		return new CommunityMemberAttachPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityMemberAttachPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityMemberAttachPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityMemberAttachPacket other)
	{
		if (other == null)
		{
			return;
