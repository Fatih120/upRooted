...
public sealed class CommunityMemberInviteCreateRequest : IMessage<CommunityMemberInviteCreateRequest>, IMessage, IEquatable<CommunityMemberInviteCreateRequest>, IDeepCloneable<CommunityMemberInviteCreateRequest>, IBufferMessage
{
	private static readonly MessageParser<CommunityMemberInviteCreateRequest> _parser = new MessageParser<CommunityMemberInviteCreateRequest>(() => new CommunityMemberInviteCreateRequest());
	...
	private static readonly FieldCodec<CommunityRoleUuid> _repeated_communityRoleIds_codec = FieldCodec.ForMessage(98u, CommunityRoleUuid.Parser);

	private readonly RepeatedField<CommunityRoleUuid> communityRoleIds_ = new RepeatedField<CommunityRoleUuid>();

	[GeneratedCode("protoc", null)]
	public static MessageParser<CommunityMemberInviteCreateRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityMemberInviteCreateRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityMemberInviteCreateRequest(CommunityMemberInviteCreateRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityMemberInviteCreateRequest Clone()
	{
		return new CommunityMemberInviteCreateRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityMemberInviteCreateRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityMemberInviteCreateRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityMemberInviteCreateRequest other)
	{
		if (other == null)
		{
			return;
