...
public sealed class ChannelDeletedPacket : IPacketCommunity, IPacket, IMessage<ChannelDeletedPacket>, IMessage, IEquatable<ChannelDeletedPacket>, IDeepCloneable<ChannelDeletedPacket>, IBufferMessage
{
	private static readonly MessageParser<ChannelDeletedPacket> _parser = new MessageParser<ChannelDeletedPacket>(() => new ChannelDeletedPacket());
	...
	public static MessageParser<ChannelDeletedPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(ChannelDeletedPacket packet)
	{
		return new PacketContainer
		{
			ChannelDeleted = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public ChannelDeletedPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public ChannelDeletedPacket(ChannelDeletedPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public ChannelDeletedPacket Clone()
	{
		return new ChannelDeletedPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as ChannelDeletedPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(ChannelDeletedPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ChannelDeletedPacket other)
	{
		if (other == null)
		{
			return;
