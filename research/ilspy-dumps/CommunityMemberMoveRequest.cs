...
public sealed class CommunityMemberMoveRequest : IMessage<CommunityMemberMoveRequest>, IMessage, IEquatable<CommunityMemberMoveRequest>, IDeepCloneable<CommunityMemberMoveRequest>, IBufferMessage
{
	private static readonly MessageParser<CommunityMemberMoveRequest> _parser = new MessageParser<CommunityMemberMoveRequest>(() => new CommunityMemberMoveRequest());
	...
	public static MessageParser<CommunityMemberMoveRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityMemberMoveRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityMemberMoveRequest(CommunityMemberMoveRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityMemberMoveRequest Clone()
	{
		return new CommunityMemberMoveRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityMemberMoveRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityMemberMoveRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityMemberMoveRequest other)
	{
		if (other == null)
		{
			return;
