...
public sealed class DirectoryResponse : IMessage<DirectoryResponse>, IMessage, IEquatable<DirectoryResponse>, IDeepCloneable<DirectoryResponse>, IBufferMessage
{
	private static readonly MessageParser<DirectoryResponse> _parser = new MessageParser<DirectoryResponse>(() => new DirectoryResponse());
	...
	public static MessageParser<DirectoryResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public DirectoryResponse Clone()
	{
	...
	{
		return Equals(other as DirectoryResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(DirectoryResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(DirectoryResponse other)
	{
		if (other == null)
		{
			return;
