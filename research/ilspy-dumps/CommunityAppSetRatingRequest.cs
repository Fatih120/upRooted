...
public sealed class CommunityAppSetRatingRequest : IMessage<CommunityAppSetRatingRequest>, IMessage, IEquatable<CommunityAppSetRatingRequest>, IDeepCloneable<CommunityAppSetRatingRequest>, IBufferMessage
{
	private static readonly MessageParser<CommunityAppSetRatingRequest> _parser = new MessageParser<CommunityAppSetRatingRequest>(() => new CommunityAppSetRatingRequest());
	...
	public static MessageParser<CommunityAppSetRatingRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppSetRatingRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityAppSetRatingRequest(CommunityAppSetRatingRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppSetRatingRequest Clone()
	{
		return new CommunityAppSetRatingRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityAppSetRatingRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityAppSetRatingRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityAppSetRatingRequest other)
	{
		if (other == null)
		{
			return;
