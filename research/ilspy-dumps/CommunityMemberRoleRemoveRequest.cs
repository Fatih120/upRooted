...
public sealed class CommunityMemberRoleRemoveRequest : IMessage<CommunityMemberRoleRemoveRequest>, IMessage, IEquatable<CommunityMemberRoleRemoveRequest>, IDeepCloneable<CommunityMemberRoleRemoveRequest>, IBufferMessage
{
	private static readonly MessageParser<CommunityMemberRoleRemoveRequest> _parser = new MessageParser<CommunityMemberRoleRemoveRequest>(() => new CommunityMemberRoleRemoveRequest());
	...
	public static MessageParser<CommunityMemberRoleRemoveRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityMemberRoleRemoveRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityMemberRoleRemoveRequest(CommunityMemberRoleRemoveRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityMemberRoleRemoveRequest Clone()
	{
		return new CommunityMemberRoleRemoveRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityMemberRoleRemoveRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityMemberRoleRemoveRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityMemberRoleRemoveRequest other)
	{
		if (other == null)
		{
			return;
