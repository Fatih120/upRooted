...
// RootApp.Client.Avalonia.UI.Home.SystemTray.Profile.Settings.BlockedUsersView
using System;
...
public class BlockedUsersView : UserControl
{
	[CompilerGenerated]
	private class XamlClosure_162
	{
		...
		{
			CompiledAvaloniaXaml.XamlIlContext.Context<BlockedUsersView> context = CreateContext(P_0);
		...
		public static CompiledAvaloniaXaml.XamlIlContext.Context<BlockedUsersView> CreateContext(IServiceProvider P_0)
		{
			CompiledAvaloniaXaml.XamlIlContext.Context<BlockedUsersView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<BlockedUsersView>(P_0, new object[1] { _0021AvaloniaResources.NamespaceInfo_003A_002FUI_002FHome_002FSystemTray_002FProfile_002FSettings_002FBlockedUsersView_002Eaxaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Home/SystemTray/Profile/Settings/BlockedUsersView.axaml");
			if (P_0 != null)
			{
				...
				if (service != null)
				{
					...
					context.RootObject = (BlockedUsersView)service;
				}
			}
			return context;
		}
	...
	[CompilerGenerated]
	private unsafe static void _0021XamlIlPopulate(IServiceProvider P_0, BlockedUsersView P_1)
	{
		CompiledAvaloniaXaml.XamlIlContext.Context<BlockedUsersView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<BlockedUsersView>(P_0, new object[1] { _0021AvaloniaResources.NamespaceInfo_003A_002FUI_002FHome_002FSystemTray_002FProfile_002FSettings_002FBlockedUsersView_002Eaxaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Home/SystemTray/Profile/Settings/BlockedUsersView.axaml")
		{
			RootObject = P_1,
		...
		CompiledBindingExtension compiledBindingExtension = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp_002EClient_002EAvalonia_002EUI_002EHome_002ESystemTray_002EProfile_002ESettings_002EBlockedUsersViewModel_002CRootApp_002EClient_002EAvalonia_002EBlockedUsers_0021Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		itemsControl4.Margin = new Thickness(24.0, 24.0, 24.0, 24.0);
		itemsControl4.ItemsPanel = new ItemsPanelTemplate
		{
			Content = XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<Control>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_162.Build_1), context)
		};
		context.PopParent();
		...
		CompiledBindingExtension compiledBindingExtension3 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp_002EClient_002EAvalonia_002EUI_002EHome_002ESystemTray_002EProfile_002ESettings_002EBlockedUsersViewModel_002CRootApp_002EClient_002EAvalonia_002EBlockedUsers_0021Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.System_002ECollections_002EObjectModel_002EReadOnlyCollection_00601_002CSystem_002ERuntime_002ECount_163_0021Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build());
		...
		Controls children4 = stackPanel4.Children;
		...
		textBlock5.Text = RootApp.Client.Avalonia.Resources.Strings.Resources.BlockedUsersEmpty;
		...
		textBlock9.Text = RootApp.Client.Avalonia.Resources.Strings.Resources.BlockedUsersEmptyDescription;
	...
	[CompilerGenerated]
	private static void _0021XamlIlPopulateTrampoline(BlockedUsersView P_0)
	{
