...
public sealed class UserSetProfilePacket : IPacket, IMessage<UserSetProfilePacket>, IMessage, IEquatable<UserSetProfilePacket>, IDeepCloneable<UserSetProfilePacket>, IBufferMessage
{
	private static readonly MessageParser<UserSetProfilePacket> _parser = new MessageParser<UserSetProfilePacket>(() => new UserSetProfilePacket());
	...
	public static MessageParser<UserSetProfilePacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(UserSetProfilePacket packet)
	{
		return new PacketContainer
		{
			UserSetProfile = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public UserSetProfilePacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public UserSetProfilePacket(UserSetProfilePacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public UserSetProfilePacket Clone()
	{
		return new UserSetProfilePacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as UserSetProfilePacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(UserSetProfilePacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(UserSetProfilePacket other)
	{
		if (other == null)
		{
			return;
