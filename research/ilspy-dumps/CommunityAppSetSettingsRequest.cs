...
public sealed class CommunityAppSetSettingsRequest : IMessage<CommunityAppSetSettingsRequest>, IMessage, IEquatable<CommunityAppSetSettingsRequest>, IDeepCloneable<CommunityAppSetSettingsRequest>, IBufferMessage
{
	private static readonly MessageParser<CommunityAppSetSettingsRequest> _parser = new MessageParser<CommunityAppSetSettingsRequest>(() => new CommunityAppSetSettingsRequest());
	...
	public static MessageParser<CommunityAppSetSettingsRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppSetSettingsRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityAppSetSettingsRequest(CommunityAppSetSettingsRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppSetSettingsRequest Clone()
	{
		return new CommunityAppSetSettingsRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityAppSetSettingsRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityAppSetSettingsRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityAppSetSettingsRequest other)
	{
		if (other == null)
		{
			return;
