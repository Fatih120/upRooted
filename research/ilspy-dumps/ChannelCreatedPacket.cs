...
public sealed class ChannelCreatedPacket : IPacketCommunity, IPacket, IMessage<ChannelCreatedPacket>, IMessage, IEquatable<ChannelCreatedPacket>, IDeepCloneable<ChannelCreatedPacket>, IBufferMessage
{
	private static readonly MessageParser<ChannelCreatedPacket> _parser = new MessageParser<ChannelCreatedPacket>(() => new ChannelCreatedPacket());
	...
	private static readonly FieldCodec<WebRtcUserDevicePacket> _repeated_webRtcMembers_codec = FieldCodec.ForMessage(106u, WebRtcUserDevicePacket.Parser);
	...
	public static MessageParser<ChannelCreatedPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(ChannelCreatedPacket packet)
	{
		return new PacketContainer
		{
			ChannelCreated = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public ChannelCreatedPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public ChannelCreatedPacket(ChannelCreatedPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public ChannelCreatedPacket Clone()
	{
		return new ChannelCreatedPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as ChannelCreatedPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(ChannelCreatedPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ChannelCreatedPacket other)
	{
		if (other == null)
		{
			return;
