...
public sealed class CommunityInviteLinkCreateResponse : IMessage<CommunityInviteLinkCreateResponse>, IMessage, IEquatable<CommunityInviteLinkCreateResponse>, IDeepCloneable<CommunityInviteLinkCreateResponse>, IBufferMessage
{
	private static readonly MessageParser<CommunityInviteLinkCreateResponse> _parser = new MessageParser<CommunityInviteLinkCreateResponse>(() => new CommunityInviteLinkCreateResponse());
	...
	public static MessageParser<CommunityInviteLinkCreateResponse> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LinkReflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	public CommunityInviteLinkCreateResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityInviteLinkCreateResponse(CommunityInviteLinkCreateResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityInviteLinkCreateResponse Clone()
	{
		return new CommunityInviteLinkCreateResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityInviteLinkCreateResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityInviteLinkCreateResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityInviteLinkCreateResponse other)
	{
		if (other == null)
		{
			return;
