...
public sealed class ChannelEditResponse : IMessage<ChannelEditResponse>, IMessage, IEquatable<ChannelEditResponse>, IDeepCloneable<ChannelEditResponse>, IBufferMessage
{
	private static readonly MessageParser<ChannelEditResponse> _parser = new MessageParser<ChannelEditResponse>(() => new ChannelEditResponse());
	...
	public static MessageParser<ChannelEditResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public ChannelEditResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public ChannelEditResponse(ChannelEditResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public ChannelEditResponse Clone()
	{
		return new ChannelEditResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as ChannelEditResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(ChannelEditResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ChannelEditResponse other)
	{
		if (other == null)
		{
			return;
