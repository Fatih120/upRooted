...
public sealed class WebRtcListTracksForSessionRequest : IMessage<WebRtcListTracksForSessionRequest>, IMessage, IEquatable<WebRtcListTracksForSessionRequest>, IDeepCloneable<WebRtcListTracksForSessionRequest>, IBufferMessage
{
	private static readonly MessageParser<WebRtcListTracksForSessionRequest> _parser = new MessageParser<WebRtcListTracksForSessionRequest>(() => new WebRtcListTracksForSessionRequest());
	...
	public static MessageParser<WebRtcListTracksForSessionRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public WebRtcListTracksForSessionRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public WebRtcListTracksForSessionRequest(WebRtcListTracksForSessionRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public WebRtcListTracksForSessionRequest Clone()
	{
		return new WebRtcListTracksForSessionRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as WebRtcListTracksForSessionRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(WebRtcListTracksForSessionRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(WebRtcListTracksForSessionRequest other)
	{
		if (other == null)
		{
			return;
