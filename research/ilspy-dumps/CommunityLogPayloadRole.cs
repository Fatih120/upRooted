...
public sealed class CommunityLogPayloadRole : IMessage, IMessage<CommunityLogPayloadRole>, IEquatable<CommunityLogPayloadRole>, IDeepCloneable<CommunityLogPayloadRole>, IBufferMessage
{
	private static readonly MessageParser<CommunityLogPayloadRole> _parser = new MessageParser<CommunityLogPayloadRole>(() => new CommunityLogPayloadRole());
	...
	private CommunityLogPayloadRoleState original_;

	private CommunityLogPayloadRoleState current_;

	private FieldMask fieldMask_;

	[GeneratedCode("protoc", null)]
	public static MessageParser<CommunityLogPayloadRole> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CommunityLogReflection.Descriptor.MessageTypes[5];
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadRoleState Original
	{
		get
		{
			return original_;
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadRoleState Current
	{
		get
		{
			return current_;
	...
	public void CreateFieldMask()
	{
		if (Current != null && Original != null)
		{
			...
			if (Original.ColorHex != Current.ColorHex)
			{
				FieldMask.Paths.Add("color_hex");
			}
			Original.ChannelPermission.MergeFieldMask(Current.ChannelPermission, FieldMask, "channel_permission.");
			Original.CommunityPermission.MergeFieldMask(Current.CommunityPermission, FieldMask, "community_permission.");
		}
	}
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadRole()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadRole(CommunityLogPayloadRole other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadRole Clone()
	{
		return new CommunityLogPayloadRole(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityLogPayloadRole);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityLogPayloadRole other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityLogPayloadRole other)
	{
		if (other == null)
		{
			return;
		...
		if (other.original_ != null)
		{
			if (original_ == null)
			{
				Original = new CommunityLogPayloadRoleState();
			}
		...
		if (other.current_ != null)
		{
			if (current_ == null)
			{
				Current = new CommunityLogPayloadRoleState();
			}
