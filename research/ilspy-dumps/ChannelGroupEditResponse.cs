...
public sealed class ChannelGroupEditResponse : IMessage<ChannelGroupEditResponse>, IMessage, IEquatable<ChannelGroupEditResponse>, IDeepCloneable<ChannelGroupEditResponse>, IBufferMessage
{
	private static readonly MessageParser<ChannelGroupEditResponse> _parser = new MessageParser<ChannelGroupEditResponse>(() => new ChannelGroupEditResponse());
	...
	public static MessageParser<ChannelGroupEditResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public ChannelGroupEditResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public ChannelGroupEditResponse(ChannelGroupEditResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public ChannelGroupEditResponse Clone()
	{
		return new ChannelGroupEditResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as ChannelGroupEditResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(ChannelGroupEditResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ChannelGroupEditResponse other)
	{
		if (other == null)
		{
			return;
