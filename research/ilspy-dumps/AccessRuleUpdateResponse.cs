...
public sealed class AccessRuleUpdateResponse : IMessage<AccessRuleUpdateResponse>, IMessage, IEquatable<AccessRuleUpdateResponse>, IDeepCloneable<AccessRuleUpdateResponse>, IBufferMessage
{
	private static readonly MessageParser<AccessRuleUpdateResponse> _parser = new MessageParser<AccessRuleUpdateResponse>(() => new AccessRuleUpdateResponse());
	...
	public static MessageParser<AccessRuleUpdateResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public AccessRuleUpdateResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public AccessRuleUpdateResponse(AccessRuleUpdateResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public AccessRuleUpdateResponse Clone()
	{
		return new AccessRuleUpdateResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as AccessRuleUpdateResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(AccessRuleUpdateResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(AccessRuleUpdateResponse other)
	{
		if (other == null)
		{
			return;
