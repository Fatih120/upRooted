...
public class ChannelGroupContainsAppView : UserControl
{
	[CompilerGenerated]
	private static Action<object> !XamlIlPopulateOverride;

	public ChannelGroupContainsAppView()
	{
		InitializeComponent();
	}
	...
	[CompilerGenerated]
	private static void !XamlIlPopulate(IServiceProvider P_0, ChannelGroupContainsAppView P_1)
	{
		CompiledAvaloniaXaml.XamlIlContext.Context<ChannelGroupContainsAppView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<ChannelGroupContainsAppView>(P_0, new object[1] { !AvaloniaResources.NamespaceInfo:/UI/Community/Channels/ChannelGroupContainsAppView.axaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Community/Channels/ChannelGroupContainsAppView.axaml")
		{
			RootObject = P_1,
	...
	[CompilerGenerated]
	private static void !XamlIlPopulateTrampoline(ChannelGroupContainsAppView P_0)
	{
