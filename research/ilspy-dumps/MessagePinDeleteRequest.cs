...
public sealed class MessagePinDeleteRequest : IMessage<MessagePinDeleteRequest>, IMessage, IEquatable<MessagePinDeleteRequest>, IDeepCloneable<MessagePinDeleteRequest>, IBufferMessage
{
	private static readonly MessageParser<MessagePinDeleteRequest> _parser = new MessageParser<MessagePinDeleteRequest>(() => new MessagePinDeleteRequest());
	...
	public static MessageParser<MessagePinDeleteRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public MessagePinDeleteRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public MessagePinDeleteRequest(MessagePinDeleteRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public MessagePinDeleteRequest Clone()
	{
		return new MessagePinDeleteRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as MessagePinDeleteRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(MessagePinDeleteRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(MessagePinDeleteRequest other)
	{
		if (other == null)
		{
			return;
