...
public sealed class AccessRuleGetRequest : IMessage<AccessRuleGetRequest>, IMessage, IEquatable<AccessRuleGetRequest>, IDeepCloneable<AccessRuleGetRequest>, IBufferMessage
{
	private static readonly MessageParser<AccessRuleGetRequest> _parser = new MessageParser<AccessRuleGetRequest>(() => new AccessRuleGetRequest());
	...
	public static MessageParser<AccessRuleGetRequest> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => AccessRuleReflection.Descriptor.MessageTypes[7];
	...
	[GeneratedCode("protoc", null)]
	public AccessRuleGetRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public AccessRuleGetRequest(AccessRuleGetRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public AccessRuleGetRequest Clone()
	{
		return new AccessRuleGetRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as AccessRuleGetRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(AccessRuleGetRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(AccessRuleGetRequest other)
	{
		if (other == null)
		{
			return;
