...
public sealed class MessageGetRequest : IMessage<MessageGetRequest>, IMessage, IEquatable<MessageGetRequest>, IDeepCloneable<MessageGetRequest>, IBufferMessage
{
	private static readonly MessageParser<MessageGetRequest> _parser = new MessageParser<MessageGetRequest>(() => new MessageGetRequest());
	...
	public static MessageParser<MessageGetRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public MessageGetRequest(MessageGetRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public MessageGetRequest Clone()
	{
	...
	{
		return Equals(other as MessageGetRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(MessageGetRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(MessageGetRequest other)
	{
		if (other == null)
		{
			return;
