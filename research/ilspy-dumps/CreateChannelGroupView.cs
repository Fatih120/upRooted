...
public class CreateChannelGroupView : UserControl
{
	...
	[CompilerGenerated]
	private static void !XamlIlPopulate(IServiceProvider P_0, CreateChannelGroupView P_1)
	{
		CompiledAvaloniaXaml.XamlIlContext.Context<CreateChannelGroupView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<CreateChannelGroupView>(P_0, new object[1] { !AvaloniaResources.NamespaceInfo:/UI/Community/Channels/CreateChannelGroupView.axaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Community/Channels/CreateChannelGroupView.axaml")
		{
			RootObject = P_1,
		...
		textBlock5.Text = RootApp.Client.Avalonia.Resources.Strings.Resources.CreateChannelGroup;
		...
		Grid.SetColumn(rootTextbox4, 0);
		rootTextbox4.Margin = new Thickness(0.0, 8.0, 0.0, 0.0);
		Grid.SetColumnSpan(rootTextbox4, 2);
		...
		button9.Content = RootApp.Client.Avalonia.Resources.Strings.Resources.Create;
		...
		rootWebApiStatus4.SendingText = RootApp.Client.Avalonia.Resources.Strings.Resources.CreatingChannelGroup;
		rootWebApiStatus4.SuccessText = RootApp.Client.Avalonia.Resources.Strings.Resources.SuccessfullyCreatedChannelGroup;
		rootWebApiStatus4.FailedText = RootApp.Client.Avalonia.Resources.Strings.Resources.FailedToCreateChannelGroup;
		context.PopParent();
	...
	[CompilerGenerated]
	private static void !XamlIlPopulateTrampoline(CreateChannelGroupView P_0)
	{
