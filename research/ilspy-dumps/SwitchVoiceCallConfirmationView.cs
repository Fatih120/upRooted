...
public class SwitchVoiceCallConfirmationView : UserControl
{
	[CompilerGenerated]
	private static Action<object> !XamlIlPopulateOverride;

	public SwitchVoiceCallConfirmationView()
	{
		InitializeComponent();
	}
	...
	[CompilerGenerated]
	private static void !XamlIlPopulate(IServiceProvider P_0, SwitchVoiceCallConfirmationView P_1)
	{
		CompiledAvaloniaXaml.XamlIlContext.Context<SwitchVoiceCallConfirmationView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<SwitchVoiceCallConfirmationView>(P_0, new object[1] { !AvaloniaResources.NamespaceInfo:/UI/Community/Channels/SwitchVoiceCallConfirmationView.axaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Community/Channels/SwitchVoiceCallConfirmationView.axaml")
		{
			RootObject = P_1,
		...
		rootConfirmationControl4.ConfirmationButtonText = RootApp.Client.Avalonia.Resources.Strings.Resources.SwitchCall;
		...
		DynamicResourceExtension dynamicResourceExtension3 = new DynamicResourceExtension("VoiceSVG");
		...
		rootConfirmationControl4.SvgWidth = 28.0;
		rootConfirmationControl4.SvgHeight = 28.0;
	...
	[CompilerGenerated]
	private static void !XamlIlPopulateTrampoline(SwitchVoiceCallConfirmationView P_0)
	{
