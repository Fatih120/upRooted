...
public sealed class WebRtcSetMuteAndDeafenRequest : IMessage<WebRtcSetMuteAndDeafenRequest>, IMessage, IEquatable<WebRtcSetMuteAndDeafenRequest>, IDeepCloneable<WebRtcSetMuteAndDeafenRequest>, IBufferMessage
{
	private static readonly MessageParser<WebRtcSetMuteAndDeafenRequest> _parser = new MessageParser<WebRtcSetMuteAndDeafenRequest>(() => new WebRtcSetMuteAndDeafenRequest());
	...
	public static MessageParser<WebRtcSetMuteAndDeafenRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public WebRtcSetMuteAndDeafenRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public WebRtcSetMuteAndDeafenRequest(WebRtcSetMuteAndDeafenRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public WebRtcSetMuteAndDeafenRequest Clone()
	{
		return new WebRtcSetMuteAndDeafenRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as WebRtcSetMuteAndDeafenRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(WebRtcSetMuteAndDeafenRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(WebRtcSetMuteAndDeafenRequest other)
	{
		if (other == null)
		{
			return;
