...
public sealed class AccessRuleEditResponse : IMessage<AccessRuleEditResponse>, IMessage, IEquatable<AccessRuleEditResponse>, IDeepCloneable<AccessRuleEditResponse>, IBufferMessage
{
	private static readonly MessageParser<AccessRuleEditResponse> _parser = new MessageParser<AccessRuleEditResponse>(() => new AccessRuleEditResponse());
	...
	public static MessageParser<AccessRuleEditResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public AccessRuleEditResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public AccessRuleEditResponse(AccessRuleEditResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public AccessRuleEditResponse Clone()
	{
		return new AccessRuleEditResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as AccessRuleEditResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(AccessRuleEditResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(AccessRuleEditResponse other)
	{
		if (other == null)
		{
			return;
