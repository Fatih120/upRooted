...
public sealed class CommunityRoleCreateResponse : IMessage<CommunityRoleCreateResponse>, IMessage, IEquatable<CommunityRoleCreateResponse>, IDeepCloneable<CommunityRoleCreateResponse>, IBufferMessage
{
	private static readonly MessageParser<CommunityRoleCreateResponse> _parser = new MessageParser<CommunityRoleCreateResponse>(() => new CommunityRoleCreateResponse());
	...
	public static MessageParser<CommunityRoleCreateResponse> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CommunityRoleReflection.Descriptor.MessageTypes[3];
	...
	[GeneratedCode("protoc", null)]
	public CommunityRoleCreateResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityRoleCreateResponse(CommunityRoleCreateResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityRoleCreateResponse Clone()
	{
		return new CommunityRoleCreateResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityRoleCreateResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityRoleCreateResponse other)
	{
		if (other == null)
		{
			return false;
	...
	public int CalculateSize()
	{
		...
		if (beforeCommunityRoleId_ != null)
		{
			num += 2 + CodedOutputStream.ComputeMessageSize(BeforeCommunityRoleId);
		}
		if (_unknownFields != null)
		{
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityRoleCreateResponse other)
	{
		if (other == null)
		{
			return;
