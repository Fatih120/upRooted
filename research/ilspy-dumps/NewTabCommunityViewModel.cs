...
public class NewTabCommunityViewModel : ViewModelBase<NewTabCommunityViewModel>
{
	...
	public NewTabCommunityViewModel(RootApp.Client.CoreDomain.Models.Community.Community P_0, BitmapCache P_1, IRootSessionAccessor P_2, CommunityOpenerService P_3, LeaveCommunityViewModelFactory P_4)
		: base((IValidator<NewTabCommunityViewModel>?)null)
	{
		Community = P_0;
		_bitmapCache = P_1;
	...
	public async Task FavoriteSelectedAsync()
	{
		try
		{
			await Community.SetFavoriteAsync(true);
		}
		catch
		{
		}
