...
public sealed class CommunityLogPayloadDirectory : IMessage, IMessage<CommunityLogPayloadDirectory>, IEquatable<CommunityLogPayloadDirectory>, IDeepCloneable<CommunityLogPayloadDirectory>, IBufferMessage
{
	private static readonly MessageParser<CommunityLogPayloadDirectory> _parser = new MessageParser<CommunityLogPayloadDirectory>(() => new CommunityLogPayloadDirectory());
	...
	private CommunityLogPayloadDirectoryState original_;

	private CommunityLogPayloadDirectoryState current_;

	private FieldMask fieldMask_;

	[GeneratedCode("protoc", null)]
	public static MessageParser<CommunityLogPayloadDirectory> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CommunityLogReflection.Descriptor.MessageTypes[20];
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadDirectoryState Original
	{
		get
		{
			return original_;
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadDirectoryState Current
	{
		get
		{
			return current_;
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadDirectory()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadDirectory(CommunityLogPayloadDirectory other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadDirectory Clone()
	{
		return new CommunityLogPayloadDirectory(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityLogPayloadDirectory);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityLogPayloadDirectory other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityLogPayloadDirectory other)
	{
		if (other == null)
		{
			return;
		...
		if (other.original_ != null)
		{
			if (original_ == null)
			{
				Original = new CommunityLogPayloadDirectoryState();
			}
		...
		if (other.current_ != null)
		{
			if (current_ == null)
			{
				Current = new CommunityLogPayloadDirectoryState();
			}
