...
public sealed class ChannelListRequest : IMessage<ChannelListRequest>, IMessage, IEquatable<ChannelListRequest>, IDeepCloneable<ChannelListRequest>, IBufferMessage
{
	private static readonly MessageParser<ChannelListRequest> _parser = new MessageParser<ChannelListRequest>(() => new ChannelListRequest());
	...
	public static MessageParser<ChannelListRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public ChannelListRequest(ChannelListRequest other)
		: this()
	{
