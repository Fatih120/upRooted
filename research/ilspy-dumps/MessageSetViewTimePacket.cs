...
public sealed class MessageSetViewTimePacket : IPacketCommunity, IPacket, IMessage<MessageSetViewTimePacket>, IMessage, IEquatable<MessageSetViewTimePacket>, IDeepCloneable<MessageSetViewTimePacket>, IBufferMessage
{
	private static readonly MessageParser<MessageSetViewTimePacket> _parser = new MessageParser<MessageSetViewTimePacket>(() => new MessageSetViewTimePacket());
	...
	public static MessageParser<MessageSetViewTimePacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(MessageSetViewTimePacket packet)
	{
		return new PacketContainer
		{
			MessageSetViewTime = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public MessageSetViewTimePacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public MessageSetViewTimePacket(MessageSetViewTimePacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public MessageSetViewTimePacket Clone()
	{
		return new MessageSetViewTimePacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as MessageSetViewTimePacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(MessageSetViewTimePacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(MessageSetViewTimePacket other)
	{
		if (other == null)
		{
			return;
