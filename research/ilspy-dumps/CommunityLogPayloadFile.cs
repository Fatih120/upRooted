...
public sealed class CommunityLogPayloadFile : IMessage, IMessage<CommunityLogPayloadFile>, IEquatable<CommunityLogPayloadFile>, IDeepCloneable<CommunityLogPayloadFile>, IBufferMessage
{
	private static readonly MessageParser<CommunityLogPayloadFile> _parser = new MessageParser<CommunityLogPayloadFile>(() => new CommunityLogPayloadFile());
	...
	private CommunityLogPayloadFileState original_;

	private CommunityLogPayloadFileState current_;

	private FieldMask fieldMask_;

	[GeneratedCode("protoc", null)]
	public static MessageParser<CommunityLogPayloadFile> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CommunityLogReflection.Descriptor.MessageTypes[22];
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadFileState Original
	{
		get
		{
			return original_;
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadFileState Current
	{
		get
		{
			return current_;
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadFile()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadFile(CommunityLogPayloadFile other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadFile Clone()
	{
		return new CommunityLogPayloadFile(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityLogPayloadFile);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityLogPayloadFile other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityLogPayloadFile other)
	{
		if (other == null)
		{
			return;
		...
		if (other.original_ != null)
		{
			if (original_ == null)
			{
				Original = new CommunityLogPayloadFileState();
			}
		...
		if (other.current_ != null)
		{
			if (current_ == null)
			{
				Current = new CommunityLogPayloadFileState();
			}
