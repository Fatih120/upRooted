...
public sealed class CommunityAppAddRequest : IMessage<CommunityAppAddRequest>, IMessage, IEquatable<CommunityAppAddRequest>, IDeepCloneable<CommunityAppAddRequest>, IBufferMessage
{
	private static readonly MessageParser<CommunityAppAddRequest> _parser = new MessageParser<CommunityAppAddRequest>(() => new CommunityAppAddRequest());
	...
	private ChannelCreateRequest channel_;
	...
	public static MessageParser<CommunityAppAddRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public ChannelCreateRequest Channel
	{
		get
		{
			return channel_;
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppAddRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityAppAddRequest(CommunityAppAddRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppAddRequest Clone()
	{
		return new CommunityAppAddRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityAppAddRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityAppAddRequest other)
	{
		if (other == null)
		{
			return false;
	...
	public int CalculateSize()
	{
		...
		if (TurnstileToken.Length != 0)
		{
			num += 2 + CodedOutputStream.ComputeStringSize(TurnstileToken);
		}
		if (_unknownFields != null)
		{
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityAppAddRequest other)
	{
		if (other == null)
		{
			return;
		...
		if (other.channel_ != null)
		{
			if (channel_ == null)
			{
				Channel = new ChannelCreateRequest();
			}
