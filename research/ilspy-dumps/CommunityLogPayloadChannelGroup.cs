...
public sealed class CommunityLogPayloadChannelGroup : IMessage, IMessage<CommunityLogPayloadChannelGroup>, IEquatable<CommunityLogPayloadChannelGroup>, IDeepCloneable<CommunityLogPayloadChannelGroup>, IBufferMessage
{
	private static readonly MessageParser<CommunityLogPayloadChannelGroup> _parser = new MessageParser<CommunityLogPayloadChannelGroup>(() => new CommunityLogPayloadChannelGroup());
	...
	private CommunityLogPayloadChannelGroupState original_;

	private CommunityLogPayloadChannelGroupState current_;

	private FieldMask fieldMask_;

	[GeneratedCode("protoc", null)]
	public static MessageParser<CommunityLogPayloadChannelGroup> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CommunityLogReflection.Descriptor.MessageTypes[26];
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadChannelGroupState Original
	{
		get
		{
			return original_;
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadChannelGroupState Current
	{
		get
		{
			return current_;
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadChannelGroup()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadChannelGroup(CommunityLogPayloadChannelGroup other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadChannelGroup Clone()
	{
		return new CommunityLogPayloadChannelGroup(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityLogPayloadChannelGroup);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityLogPayloadChannelGroup other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityLogPayloadChannelGroup other)
	{
		if (other == null)
		{
			return;
		...
		if (other.original_ != null)
		{
			if (original_ == null)
			{
				Original = new CommunityLogPayloadChannelGroupState();
			}
		...
		if (other.current_ != null)
		{
			if (current_ == null)
			{
				Current = new CommunityLogPayloadChannelGroupState();
			}
