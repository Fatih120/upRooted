...
public class App : Application
{
	...
	private class XamlClosure_1
	{
		...
		{
			CompiledAvaloniaXaml.XamlIlContext.Context<App> context = new CompiledAvaloniaXaml.XamlIlContext.Context<App>(P_0, new object[1] { _0021AvaloniaResources.NamespaceInfo_003A_002FApp_002Eaxaml.Singleton }, "avares://RootApp.Client.Avalonia/App.axaml");
			if (P_0 != null)
			{
	...
	public App(MainViewModelFactory P_0, RootAppVersion P_1, ILoggerFactory P_2, HostedServicesRunner P_3, IHostApplicationLifetime P_4, ThemeService P_5, BrowserService P_6, IRootSessionAccessor P_7, IApplicationRestart P_8, ILocalDataStore P_9, IOptions<RootApplicationOptions> P_10, LinkJoiningService P_11, KeybindingDispatchService P_12)
	{
		...
		P_2.AddSentry(delegate(SentryLoggingOptions sentryLoggingOptions)
		{
			sentryLoggingOptions.Dsn = "https://89f5d53859240a8c0100dfe7ac936753@o4509469920133120.ingest.us.sentry.io/4509470042554378";
			sentryLoggingOptions.InitializeSdk = true;
			sentryLoggingOptions.Debug = false;
			sentryLoggingOptions.StackTraceMode = StackTraceMode.Enhanced;
			sentryLoggingOptions.SetBeforeSend(delegate(SentryEvent sentryEvent, SentryHint _)
			{
	...
	public override void OnFrameworkInitializationCompleted()
	{
		...
		Avalonia.Controls.ApplicationLifetimes.IApplicationLifetime applicationLifetime = base.ApplicationLifetime;
		Avalonia.Controls.ApplicationLifetimes.IApplicationLifetime applicationLifetime2 = applicationLifetime;
	...
	private unsafe static void _0021XamlIlPopulate(IServiceProvider P_0, App P_1)
	{
		...
		resourceDictionary4.MergedDictionaries.Add(_0021AvaloniaResources.Build_003A_002FResources_002FThemes_002FLight_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		...
		resourceDictionary5.MergedDictionaries.Add(_0021AvaloniaResources.Build_003A_002FResources_002FThemes_002FDark_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		...
		resourceDictionary6.MergedDictionaries.Add(_0021AvaloniaResources.Build_003A_002FResources_002FThemes_002FPureDark_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		((IThemeVariantProvider)resourceDictionary6).Key = ThemeMapper.PureDark;
		context.PopParent();
		themeDictionaries3.Add(pureDark, value3);
		resourceDictionary2.MergedDictionaries.Add(_0021AvaloniaResources.Build_003A_002FResources_002FFonts_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		resourceDictionary2.MergedDictionaries.Add(_0021AvaloniaResources.Build_003A_002FResources_002FSounds_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		...
		style2.Add(setter2);
		styles2.Add(style2);
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FThemes_002FSimple_002FAvaloniaEdit_002Examl(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FColorPicker_002FRootColorPicker_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FBorderlessTextbox_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FBorderButton_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FTransparentButton_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FLinkButton_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FTextButton_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FScrollViewer_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FListBox_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FSvgButton_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FListBoxItem_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FTabItem_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FCheckBox_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FMenuFlyoutPresenter_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FFlyoutPresenter_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FMenuItem_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FSeparator_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FTabsTheme_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FRootImageLoader_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FComboBox_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FComboBoxItem_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FMessageMarkdown_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FDropDownButton_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FRootSplitView_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FToolTip_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		app2.Styles.Add(_0021AvaloniaResources.Build_003A_002FResources_002FStyles_002FSlider_002Eaxaml(XamlIlRuntimeHelpers.CreateRootServiceProviderV3(context)));
		context.PopParent();
