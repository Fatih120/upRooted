...
public class MediaViewerView : UserControl
{
	...
	private MediaViewerViewModel _viewModel => (MediaViewerViewModel)base.DataContext;
	...
	[CompilerGenerated]
	private static void !XamlIlPopulate(IServiceProvider P_0, MediaViewerView P_1)
	{
		CompiledAvaloniaXaml.XamlIlContext.Context<MediaViewerView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<MediaViewerView>(P_0, new object[1] { !AvaloniaResources.NamespaceInfo:/UI/MediaViewer/MediaViewerView.axaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/MediaViewer/MediaViewerView.axaml")
		{
			RootObject = P_1,
		...
		CompiledBindingExtension compiledBindingExtension = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.CopyImageCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		CompiledBindingExtension compiledBindingExtension3 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.CanCopyToClipboard!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		CompiledBindingExtension compiledBindingExtension5 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.SaveImageCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = MenuItem.CommandProperty;
		...
		CompiledBindingExtension compiledBindingExtension7 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.CanDownload!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		{
			Path = new CompiledBindingPathBuilder(1).ElementName(context.AvaloniaNameScope, "CopyToClipboardMenuItem").Property(Visual.IsVisibleProperty, PropertyInfoAccessorFactory.CreateAvaloniaPropertyAccessor).Build()
		};
		...
		{
			Path = new CompiledBindingPathBuilder(1).ElementName(context.AvaloniaNameScope, "DownloadMenuItem").Property(Visual.IsVisibleProperty, PropertyInfoAccessorFactory.CreateAvaloniaPropertyAccessor).Build()
		};
		context.ProvideTargetProperty = CompiledAvaloniaXaml.XamlIlHelpers.Avalonia.Data.MultiBinding,Avalonia.Markup.Bindings!Property();
		...
		bindings2.Add(item2);
		context.PopParent();
		AvaloniaObjectExtensions.Bind(separator4, isVisibleProperty3, multiBinding);
		context.PopParent();
		...
		CompiledBindingExtension compiledBindingExtension9 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.CopyLinkCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = MenuItem.CommandProperty;
		...
		CompiledBindingExtension compiledBindingExtension11 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.OpenLinkCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = MenuItem.CommandProperty;
		...
		StaticResourceExtension obj5 = new StaticResourceExtension
		{
			ResourceKey = "SharedMenu"
		};
		context.ProvideTargetProperty = Control.ContextFlyoutProperty;
		object? obj6 = obj5.ProvideValue(context);
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_25(P_1, obj6);
		Panel panel2;
		...
		StyledProperty<ICommand?> commandProperty5 = InvokeCommandActionBase.CommandProperty;
		CompiledBindingExtension compiledBindingExtension13 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.CloseViewModelCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(invokeCommandAction2, commandProperty5, compiledBindingExtension14);
		context.PopParent();
		...
		CompiledBindingExtension compiledBindingExtension15 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.ProfilePictureAsyncBitmapWrapper!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).StreamTask<BitmapWrapper>().Build());
		...
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(rootImageLoader4, sourceProperty, compiledBindingExtension16);
		...
		CompiledBindingExtension compiledBindingExtension17 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.Attachment!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Attachment,RootApp.Client.CoreDomain.Filename!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		object? obj7 = staticResourceExtension2.ProvideValue(context);
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock5, obj7);
		...
		CompiledBindingExtension compiledBindingExtension19 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.UserName!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = TextBlock.TextProperty;
		...
		CompiledBindingExtension compiledBindingExtension21 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.CanDownload!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		CompiledBindingExtension compiledBindingExtension22 = compiledBindingExtension21.ProvideValue(context);
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(border9, isVisibleProperty4, compiledBindingExtension22);
		...
		CompiledBindingExtension compiledBindingExtension23 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.SaveImageCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(rootSvgButton5, commandProperty6, compiledBindingExtension24);
		context.PopParent();
		...
		CompiledBindingExtension compiledBindingExtension25 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.IsDownloading!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		CompiledBindingExtension compiledBindingExtension26 = compiledBindingExtension25.ProvideValue(context);
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(border13, isVisibleProperty5, compiledBindingExtension26);
		border13.Width = 30.0;
		...
		CompiledBindingExtension compiledBindingExtension27 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.DownloadPercentage!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(rootCircleProgressBar4, valueProperty, compiledBindingExtension28);
		context.PopParent();
		...
		CompiledBindingExtension compiledBindingExtension29 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.DownloadPercentage!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = TextBlock.TextProperty;
		CompiledBindingExtension compiledBindingExtension30 = compiledBindingExtension29.ProvideValue(context);
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(textBlock13, textProperty3, compiledBindingExtension30);
		...
		CompiledBindingExtension compiledBindingExtension31 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.DownloadComplete!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		CompiledBindingExtension compiledBindingExtension32 = compiledBindingExtension31.ProvideValue(context);
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(border17, isVisibleProperty6, compiledBindingExtension32);
		...
		CompiledBindingExtension compiledBindingExtension33 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.OpenContainerFolderCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Button.CommandProperty;
		CompiledBindingExtension compiledBindingExtension34 = compiledBindingExtension33.ProvideValue(context);
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(rootSvgButton9, commandProperty7, compiledBindingExtension34);
		context.PopParent();
		...
		StaticResourceExtension staticResourceExtension5 = new StaticResourceExtension("SharedMenu");
		context.ProvideTargetProperty = Button.FlyoutProperty;
		object? obj10 = staticResourceExtension5.ProvideValue(context);
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_24(rootSvgButton13, obj10);
		context.PopParent();
		...
		context.ProvideTargetProperty = null;
		AvaloniaObjectExtensions.Bind(rootSvgButton17, commandProperty8, compiledBindingExtension36);
		...
		Grid.SetColumnSpan(contentControl4, 7);
		Grid.SetColumn(contentControl4, 0);
		CompiledBindingExtension compiledBindingExtension37 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.MediaViewer.MediaViewerViewModel,RootApp.Client.Avalonia.MediaViewerContent!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_4(contentControl4, compiledBindingExtension38);
		contentControl4.Margin = new Thickness(12.0, 0.0, 12.0, 12.0);
		context.PopParent();
	...
	[CompilerGenerated]
	private static void !XamlIlPopulateTrampoline(MediaViewerView P_0)
	{
