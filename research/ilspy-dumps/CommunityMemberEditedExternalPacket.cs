...
public sealed class CommunityMemberEditedExternalPacket : IPacketCommunity, IPacket, IMessage<CommunityMemberEditedExternalPacket>, IMessage, IEquatable<CommunityMemberEditedExternalPacket>, IDeepCloneable<CommunityMemberEditedExternalPacket>, IBufferMessage
{
	private static readonly MessageParser<CommunityMemberEditedExternalPacket> _parser = new MessageParser<CommunityMemberEditedExternalPacket>(() => new CommunityMemberEditedExternalPacket());
	...
	public static MessageParser<CommunityMemberEditedExternalPacket> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CommunityReflection.Descriptor.MessageTypes[9];
	...
	public static implicit operator PacketContainer(CommunityMemberEditedExternalPacket packet)
	{
		return new PacketContainer
		{
			CommunityMemberEditedExternal = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public CommunityMemberEditedExternalPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityMemberEditedExternalPacket(CommunityMemberEditedExternalPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityMemberEditedExternalPacket Clone()
	{
		return new CommunityMemberEditedExternalPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityMemberEditedExternalPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityMemberEditedExternalPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityMemberEditedExternalPacket other)
	{
		if (other == null)
		{
			return;
