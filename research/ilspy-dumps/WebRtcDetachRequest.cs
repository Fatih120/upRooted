...
public sealed class WebRtcDetachRequest : IMessage<WebRtcDetachRequest>, IMessage, IEquatable<WebRtcDetachRequest>, IDeepCloneable<WebRtcDetachRequest>, IBufferMessage
{
	private static readonly MessageParser<WebRtcDetachRequest> _parser = new MessageParser<WebRtcDetachRequest>(() => new WebRtcDetachRequest());
	...
	public static MessageParser<WebRtcDetachRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public WebRtcDetachRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public WebRtcDetachRequest(WebRtcDetachRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public WebRtcDetachRequest Clone()
	{
		return new WebRtcDetachRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as WebRtcDetachRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(WebRtcDetachRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(WebRtcDetachRequest other)
	{
		if (other == null)
		{
			return;
