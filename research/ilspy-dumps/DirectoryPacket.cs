...
public sealed class DirectoryPacket : IPacketCommunity, IPacket, IMessage<DirectoryPacket>, IMessage, IEquatable<DirectoryPacket>, IDeepCloneable<DirectoryPacket>, IBufferMessage
{
	private static readonly MessageParser<DirectoryPacket> _parser = new MessageParser<DirectoryPacket>(() => new DirectoryPacket());
	...
	public static MessageParser<DirectoryPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(DirectoryPacket packet)
	{
	...
	[GeneratedCode("protoc", null)]
	public DirectoryPacket(DirectoryPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public DirectoryPacket Clone()
	{
		return new DirectoryPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as DirectoryPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(DirectoryPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(DirectoryPacket other)
	{
		if (other == null)
		{
			return;
