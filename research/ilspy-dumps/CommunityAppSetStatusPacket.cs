...
public sealed class CommunityAppSetStatusPacket : IPacketCommunity, IPacket, IMessage<CommunityAppSetStatusPacket>, IMessage, IEquatable<CommunityAppSetStatusPacket>, IDeepCloneable<CommunityAppSetStatusPacket>, IBufferMessage
{
	private static readonly MessageParser<CommunityAppSetStatusPacket> _parser = new MessageParser<CommunityAppSetStatusPacket>(() => new CommunityAppSetStatusPacket());
	...
	public static MessageParser<CommunityAppSetStatusPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(CommunityAppSetStatusPacket packet)
	{
		return new PacketContainer
		{
			CommunityAppSetStatus = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public CommunityAppSetStatusPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityAppSetStatusPacket(CommunityAppSetStatusPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppSetStatusPacket Clone()
	{
		return new CommunityAppSetStatusPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityAppSetStatusPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityAppSetStatusPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityAppSetStatusPacket other)
	{
		if (other == null)
		{
			return;
