...
public sealed class WebRtcUserDeviceSetTransportPacket : IPacketWebRtc, IPacket, IMessage<WebRtcUserDeviceSetTransportPacket>, IMessage, IEquatable<WebRtcUserDeviceSetTransportPacket>, IDeepCloneable<WebRtcUserDeviceSetTransportPacket>, IBufferMessage
{
	private static readonly MessageParser<WebRtcUserDeviceSetTransportPacket> _parser = new MessageParser<WebRtcUserDeviceSetTransportPacket>(() => new WebRtcUserDeviceSetTransportPacket());
	...
	public static MessageParser<WebRtcUserDeviceSetTransportPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(WebRtcUserDeviceSetTransportPacket packet)
	{
		return new PacketContainer
		{
			WebRtcUserDeviceSetTransport = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public WebRtcUserDeviceSetTransportPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public WebRtcUserDeviceSetTransportPacket(WebRtcUserDeviceSetTransportPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public WebRtcUserDeviceSetTransportPacket Clone()
	{
		return new WebRtcUserDeviceSetTransportPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as WebRtcUserDeviceSetTransportPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(WebRtcUserDeviceSetTransportPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(WebRtcUserDeviceSetTransportPacket other)
	{
		if (other == null)
		{
			return;
