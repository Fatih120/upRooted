...
public sealed class CommunityLogPayloadMember : IMessage, IMessage<CommunityLogPayloadMember>, IEquatable<CommunityLogPayloadMember>, IDeepCloneable<CommunityLogPayloadMember>, IBufferMessage
{
	private static readonly MessageParser<CommunityLogPayloadMember> _parser = new MessageParser<CommunityLogPayloadMember>(() => new CommunityLogPayloadMember());
	...
	public static MessageParser<CommunityLogPayloadMember> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CommunityLogReflection.Descriptor.MessageTypes[10];
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadMember()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadMember(CommunityLogPayloadMember other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadMember Clone()
	{
		return new CommunityLogPayloadMember(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityLogPayloadMember);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityLogPayloadMember other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityLogPayloadMember other)
	{
		if (other == null)
		{
			return;
