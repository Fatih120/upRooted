...
public class ScreenshareAudioFailedView : UserControl
{
	[CompilerGenerated]
	private static Action<object> !XamlIlPopulateOverride;

	public ScreenshareAudioFailedView()
	{
		InitializeComponent();
	}
	...
	[CompilerGenerated]
	private static void !XamlIlPopulate(IServiceProvider P_0, ScreenshareAudioFailedView P_1)
	{
		CompiledAvaloniaXaml.XamlIlContext.Context<ScreenshareAudioFailedView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<ScreenshareAudioFailedView>(P_0, new object[1] { !AvaloniaResources.NamespaceInfo:/UI/Home/VoiceBar/ScreenshareAudioFailedView.axaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Home/VoiceBar/ScreenshareAudioFailedView.axaml")
		{
			RootObject = P_1,
		...
		CompiledBindingExtension compiledBindingExtension = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Home.VoiceBar.ScreenshareAudioFailedViewModel,RootApp.Client.Avalonia.MarkdownEngine!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		rootConfirmationControl4.TitleText = RootApp.Client.Avalonia.Resources.Strings.Resources.ScreenshareAudioFailedTitle;
		StyledProperty<string> confirmationMessageProperty = RootConfirmationControl.ConfirmationMessageProperty;
		CompiledBindingExtension compiledBindingExtension3 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Home.VoiceBar.ScreenshareAudioFailedViewModel,RootApp.Client.Avalonia.ErrorMessage!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		DynamicResourceExtension dynamicResourceExtension = new DynamicResourceExtension("ShareScreenSVG");
		...
		CompiledBindingExtension compiledBindingExtension5 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Home.VoiceBar.ScreenshareAudioFailedViewModel,RootApp.Client.Avalonia.CloseViewModelCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		CompiledBindingExtension compiledBindingExtension7 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Home.VoiceBar.ScreenshareAudioFailedViewModel,RootApp.Client.Avalonia.CloseViewModelCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
	...
	[CompilerGenerated]
	private static void !XamlIlPopulateTrampoline(ScreenshareAudioFailedView P_0)
	{
