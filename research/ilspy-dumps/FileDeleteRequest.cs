...
public sealed class FileDeleteRequest : IMessage<FileDeleteRequest>, IMessage, IEquatable<FileDeleteRequest>, IDeepCloneable<FileDeleteRequest>, IBufferMessage
{
	private static readonly MessageParser<FileDeleteRequest> _parser = new MessageParser<FileDeleteRequest>(() => new FileDeleteRequest());
	...
	public static MessageParser<FileDeleteRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public FileDeleteRequest(FileDeleteRequest other)
		: this()
	{
	...
	{
		return Equals(other as FileDeleteRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(FileDeleteRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(FileDeleteRequest other)
	{
		if (other == null)
		{
			return;
