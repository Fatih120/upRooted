...
public sealed class CommunityLogPayloadApp : IMessage, IMessage<CommunityLogPayloadApp>, IEquatable<CommunityLogPayloadApp>, IDeepCloneable<CommunityLogPayloadApp>, IBufferMessage
{
	private static readonly MessageParser<CommunityLogPayloadApp> _parser = new MessageParser<CommunityLogPayloadApp>(() => new CommunityLogPayloadApp());
	...
	public static MessageParser<CommunityLogPayloadApp> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CommunityLogReflection.Descriptor.MessageTypes[27];
	...
	public string AppName
	{
		...
		set
		{
			appName_ = ProtoPreconditions.CheckNotNull(value, "value");
		}
	}
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadApp()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadApp(CommunityLogPayloadApp other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityLogPayloadApp Clone()
	{
		return new CommunityLogPayloadApp(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityLogPayloadApp);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityLogPayloadApp other)
	{
		if (other == null)
		{
			return false;
	...
	public int CalculateSize()
	{
		...
		if (AppName.Length != 0)
		{
			num += 1 + CodedOutputStream.ComputeStringSize(AppName);
		}
		if (_unknownFields != null)
		{
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityLogPayloadApp other)
	{
		if (other == null)
		{
			return;
