...
public sealed class CommunityEditResponse : IMessage<CommunityEditResponse>, IMessage, IEquatable<CommunityEditResponse>, IDeepCloneable<CommunityEditResponse>, IBufferMessage
{
	private static readonly MessageParser<CommunityEditResponse> _parser = new MessageParser<CommunityEditResponse>(() => new CommunityEditResponse());
	...
	public static MessageParser<CommunityEditResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityEditResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityEditResponse(CommunityEditResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityEditResponse Clone()
	{
		return new CommunityEditResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityEditResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityEditResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityEditResponse other)
	{
		if (other == null)
		{
			return;
