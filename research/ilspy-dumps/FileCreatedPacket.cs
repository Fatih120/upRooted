...
public sealed class FileCreatedPacket : IPacketCommunity, IPacket, IMessage<FileCreatedPacket>, IMessage, IEquatable<FileCreatedPacket>, IDeepCloneable<FileCreatedPacket>, IBufferMessage
{
	private static readonly MessageParser<FileCreatedPacket> _parser = new MessageParser<FileCreatedPacket>(() => new FileCreatedPacket());
	...
	public static MessageParser<FileCreatedPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(FileCreatedPacket packet)
	{
	...
	[GeneratedCode("protoc", null)]
	public FileCreatedPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public FileCreatedPacket(FileCreatedPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public FileCreatedPacket Clone()
	{
		return new FileCreatedPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as FileCreatedPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(FileCreatedPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(FileCreatedPacket other)
	{
		if (other == null)
		{
			return;
