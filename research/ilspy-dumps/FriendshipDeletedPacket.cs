...
public sealed class FriendshipDeletedPacket : IPacket, IMessage<FriendshipDeletedPacket>, IMessage, IEquatable<FriendshipDeletedPacket>, IDeepCloneable<FriendshipDeletedPacket>, IBufferMessage
{
	private static readonly MessageParser<FriendshipDeletedPacket> _parser = new MessageParser<FriendshipDeletedPacket>(() => new FriendshipDeletedPacket());
	...
	public static MessageParser<FriendshipDeletedPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(FriendshipDeletedPacket packet)
	{
		return new PacketContainer
		{
			FriendshipDeleted = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public FriendshipDeletedPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public FriendshipDeletedPacket(FriendshipDeletedPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public FriendshipDeletedPacket Clone()
	{
		return new FriendshipDeletedPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as FriendshipDeletedPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(FriendshipDeletedPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(FriendshipDeletedPacket other)
	{
		if (other == null)
		{
			return;
