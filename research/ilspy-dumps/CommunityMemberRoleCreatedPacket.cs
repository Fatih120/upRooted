...
public sealed class CommunityMemberRoleCreatedPacket : IPacketCommunity, IPacket, IMessage<CommunityMemberRoleCreatedPacket>, IMessage, IEquatable<CommunityMemberRoleCreatedPacket>, IDeepCloneable<CommunityMemberRoleCreatedPacket>, IBufferMessage
{
	private static readonly MessageParser<CommunityMemberRoleCreatedPacket> _parser = new MessageParser<CommunityMemberRoleCreatedPacket>(() => new CommunityMemberRoleCreatedPacket());
	...
	public static MessageParser<CommunityMemberRoleCreatedPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(CommunityMemberRoleCreatedPacket packet)
	{
		return new PacketContainer
		{
			CommunityMemberRoleCreated = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public CommunityMemberRoleCreatedPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityMemberRoleCreatedPacket(CommunityMemberRoleCreatedPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityMemberRoleCreatedPacket Clone()
	{
		return new CommunityMemberRoleCreatedPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityMemberRoleCreatedPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityMemberRoleCreatedPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityMemberRoleCreatedPacket other)
	{
		if (other == null)
		{
			return;
