...
public sealed class ChannelMoveResponse : IMessage<ChannelMoveResponse>, IMessage, IEquatable<ChannelMoveResponse>, IDeepCloneable<ChannelMoveResponse>, IBufferMessage
{
	private static readonly MessageParser<ChannelMoveResponse> _parser = new MessageParser<ChannelMoveResponse>(() => new ChannelMoveResponse());
	...
	public static MessageParser<ChannelMoveResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public ChannelMoveResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public ChannelMoveResponse(ChannelMoveResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public ChannelMoveResponse Clone()
	{
		return new ChannelMoveResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as ChannelMoveResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(ChannelMoveResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ChannelMoveResponse other)
	{
		if (other == null)
		{
			return;
