...
public sealed class ChannelGroupMoveRequest : IMessage<ChannelGroupMoveRequest>, IMessage, IEquatable<ChannelGroupMoveRequest>, IDeepCloneable<ChannelGroupMoveRequest>, IBufferMessage
{
	private static readonly MessageParser<ChannelGroupMoveRequest> _parser = new MessageParser<ChannelGroupMoveRequest>(() => new ChannelGroupMoveRequest());
	...
	public static MessageParser<ChannelGroupMoveRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public ChannelGroupMoveRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public ChannelGroupMoveRequest(ChannelGroupMoveRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public ChannelGroupMoveRequest Clone()
	{
		return new ChannelGroupMoveRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as ChannelGroupMoveRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(ChannelGroupMoveRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ChannelGroupMoveRequest other)
	{
		if (other == null)
		{
			return;
