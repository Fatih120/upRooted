...
public sealed class MessageReactionDeleteRequest : IMessage<MessageReactionDeleteRequest>, IMessage, IEquatable<MessageReactionDeleteRequest>, IDeepCloneable<MessageReactionDeleteRequest>, IBufferMessage
{
	private static readonly MessageParser<MessageReactionDeleteRequest> _parser = new MessageParser<MessageReactionDeleteRequest>(() => new MessageReactionDeleteRequest());
	...
	public static MessageParser<MessageReactionDeleteRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public MessageReactionDeleteRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public MessageReactionDeleteRequest(MessageReactionDeleteRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public MessageReactionDeleteRequest Clone()
	{
		return new MessageReactionDeleteRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as MessageReactionDeleteRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(MessageReactionDeleteRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(MessageReactionDeleteRequest other)
	{
		if (other == null)
		{
			return;
