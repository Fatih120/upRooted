...
public sealed class DirectMessageCreateRequest : IMessage<DirectMessageCreateRequest>, IMessage, IEquatable<DirectMessageCreateRequest>, IDeepCloneable<DirectMessageCreateRequest>, IBufferMessage
{
	private static readonly MessageParser<DirectMessageCreateRequest> _parser = new MessageParser<DirectMessageCreateRequest>(() => new DirectMessageCreateRequest());
	...
	public static MessageParser<DirectMessageCreateRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public DirectMessageCreateRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public DirectMessageCreateRequest(DirectMessageCreateRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public DirectMessageCreateRequest Clone()
	{
		return new DirectMessageCreateRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as DirectMessageCreateRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(DirectMessageCreateRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(DirectMessageCreateRequest other)
	{
		if (other == null)
		{
			return;
