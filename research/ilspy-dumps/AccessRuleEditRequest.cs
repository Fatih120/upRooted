...
public sealed class AccessRuleEditRequest : IMessage<AccessRuleEditRequest>, IMessage, IEquatable<AccessRuleEditRequest>, IDeepCloneable<AccessRuleEditRequest>, IBufferMessage
{
	private static readonly MessageParser<AccessRuleEditRequest> _parser = new MessageParser<AccessRuleEditRequest>(() => new AccessRuleEditRequest());
	...
	public static MessageParser<AccessRuleEditRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public AccessRuleEditRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public AccessRuleEditRequest(AccessRuleEditRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public AccessRuleEditRequest Clone()
	{
		return new AccessRuleEditRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as AccessRuleEditRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(AccessRuleEditRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(AccessRuleEditRequest other)
	{
		if (other == null)
		{
			return;
