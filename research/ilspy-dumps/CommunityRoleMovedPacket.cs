...
public sealed class CommunityRoleMovedPacket : IPacketCommunity, IPacket, IMessage<CommunityRoleMovedPacket>, IMessage, IEquatable<CommunityRoleMovedPacket>, IDeepCloneable<CommunityRoleMovedPacket>, IBufferMessage
{
	private static readonly MessageParser<CommunityRoleMovedPacket> _parser = new MessageParser<CommunityRoleMovedPacket>(() => new CommunityRoleMovedPacket());
	...
	public static MessageParser<CommunityRoleMovedPacket> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CommunityReflection.Descriptor.MessageTypes[15];
	...
	public static implicit operator PacketContainer(CommunityRoleMovedPacket packet)
	{
		return new PacketContainer
		{
			CommunityRoleMoved = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public CommunityRoleMovedPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityRoleMovedPacket(CommunityRoleMovedPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityRoleMovedPacket Clone()
	{
		return new CommunityRoleMovedPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityRoleMovedPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityRoleMovedPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityRoleMovedPacket other)
	{
		if (other == null)
		{
			return;
