...
public sealed class CommunityAppRemoveRequest : IMessage<CommunityAppRemoveRequest>, IMessage, IEquatable<CommunityAppRemoveRequest>, IDeepCloneable<CommunityAppRemoveRequest>, IBufferMessage
{
	private static readonly MessageParser<CommunityAppRemoveRequest> _parser = new MessageParser<CommunityAppRemoveRequest>(() => new CommunityAppRemoveRequest());
	...
	public static MessageParser<CommunityAppRemoveRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppRemoveRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityAppRemoveRequest(CommunityAppRemoveRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppRemoveRequest Clone()
	{
		return new CommunityAppRemoveRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityAppRemoveRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityAppRemoveRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityAppRemoveRequest other)
	{
		if (other == null)
		{
			return;
