...
public sealed class CommunityJoinThrottle : IMessage<CommunityJoinThrottle>, IMessage, IEquatable<CommunityJoinThrottle>, IDeepCloneable<CommunityJoinThrottle>, IBufferMessage
{
	private static readonly MessageParser<CommunityJoinThrottle> _parser = new MessageParser<CommunityJoinThrottle>(() => new CommunityJoinThrottle());
	...
	public static MessageParser<CommunityJoinThrottle> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityJoinThrottle()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityJoinThrottle(CommunityJoinThrottle other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityJoinThrottle Clone()
	{
		return new CommunityJoinThrottle(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityJoinThrottle);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityJoinThrottle other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityJoinThrottle other)
	{
		if (other != null)
		{
