...
public sealed class WebRtcTracksCloseResponse : IMessage<WebRtcTracksCloseResponse>, IMessage, IEquatable<WebRtcTracksCloseResponse>, IDeepCloneable<WebRtcTracksCloseResponse>, IBufferMessage
{
	private static readonly MessageParser<WebRtcTracksCloseResponse> _parser = new MessageParser<WebRtcTracksCloseResponse>(() => new WebRtcTracksCloseResponse());
	...
	public static MessageParser<WebRtcTracksCloseResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public WebRtcTracksCloseResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	public WebRtcTracksCloseResponse(WebRtcTracksCloseResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public WebRtcTracksCloseResponse Clone()
	{
		return new WebRtcTracksCloseResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as WebRtcTracksCloseResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(WebRtcTracksCloseResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(WebRtcTracksCloseResponse other)
	{
		if (other == null)
		{
			return;
