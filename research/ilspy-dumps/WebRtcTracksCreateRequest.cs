...
public sealed class WebRtcTracksCreateRequest : IMessage<WebRtcTracksCreateRequest>, IMessage, IEquatable<WebRtcTracksCreateRequest>, IDeepCloneable<WebRtcTracksCreateRequest>, IBufferMessage
{
	private static readonly MessageParser<WebRtcTracksCreateRequest> _parser = new MessageParser<WebRtcTracksCreateRequest>(() => new WebRtcTracksCreateRequest());
	...
	private static readonly FieldCodec<WebRtcTrackCreateRequest> _repeated_tracks_codec = FieldCodec.ForMessage(98u, WebRtcTrackCreateRequest.Parser);

	private readonly RepeatedField<WebRtcTrackCreateRequest> tracks_ = new RepeatedField<WebRtcTrackCreateRequest>();

	private WebRtcSessionDescription sessionDescription_;

	[GeneratedCode("protoc", null)]
	public static MessageParser<WebRtcTracksCreateRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public RepeatedField<WebRtcTrackCreateRequest> Tracks => tracks_;
	...
	[GeneratedCode("protoc", null)]
	public WebRtcTracksCreateRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public WebRtcTracksCreateRequest(WebRtcTracksCreateRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public WebRtcTracksCreateRequest Clone()
	{
		return new WebRtcTracksCreateRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as WebRtcTracksCreateRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(WebRtcTracksCreateRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(WebRtcTracksCreateRequest other)
	{
		if (other == null)
		{
			return;
