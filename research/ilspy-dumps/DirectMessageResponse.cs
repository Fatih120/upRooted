...
public sealed class DirectMessageResponse : IMessage<DirectMessageResponse>, IMessage, IEquatable<DirectMessageResponse>, IDeepCloneable<DirectMessageResponse>, IBufferMessage
{
	private static readonly MessageParser<DirectMessageResponse> _parser = new MessageParser<DirectMessageResponse>(() => new DirectMessageResponse());
	...
	public static MessageParser<DirectMessageResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public DirectMessageResponse(DirectMessageResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public DirectMessageResponse Clone()
	{
		return new DirectMessageResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as DirectMessageResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(DirectMessageResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(DirectMessageResponse other)
	{
		if (other == null)
		{
			return;
