...
public sealed class DirectoryCreateResponse : IMessage<DirectoryCreateResponse>, IMessage, IEquatable<DirectoryCreateResponse>, IDeepCloneable<DirectoryCreateResponse>, IBufferMessage
{
	private static readonly MessageParser<DirectoryCreateResponse> _parser = new MessageParser<DirectoryCreateResponse>(() => new DirectoryCreateResponse());
	...
	public static MessageParser<DirectoryCreateResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public DirectoryCreateResponse(DirectoryCreateResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public DirectoryCreateResponse Clone()
	{
		return new DirectoryCreateResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as DirectoryCreateResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(DirectoryCreateResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(DirectoryCreateResponse other)
	{
		if (other == null)
		{
			return;
