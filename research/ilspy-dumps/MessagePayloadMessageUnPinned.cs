...
public sealed class MessagePayloadMessageUnPinned : IMessage, IMessage<MessagePayloadMessageUnPinned>, IEquatable<MessagePayloadMessageUnPinned>, IDeepCloneable<MessagePayloadMessageUnPinned>, IBufferMessage
{
	private static readonly MessageParser<MessagePayloadMessageUnPinned> _parser = new MessageParser<MessagePayloadMessageUnPinned>(() => new MessagePayloadMessageUnPinned());
	...
	public static MessageParser<MessagePayloadMessageUnPinned> Parser => _parser;

	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MessagesReflection.Descriptor.MessageTypes[8];
	...
	public MessagePayloadItem ToPayloadItem()
	{
		...
		{
			MessageUnPinned = this
		};
	}

	[GeneratedCode("protoc", null)]
	public MessagePayloadMessageUnPinned()
	{
	}

	[GeneratedCode("protoc", null)]
	public MessagePayloadMessageUnPinned(MessagePayloadMessageUnPinned other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public MessagePayloadMessageUnPinned Clone()
	{
		return new MessagePayloadMessageUnPinned(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as MessagePayloadMessageUnPinned);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(MessagePayloadMessageUnPinned other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(MessagePayloadMessageUnPinned other)
	{
		if (other == null)
		{
			return;
