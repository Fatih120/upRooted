...
public sealed class WebRtcRenegotiateRequest : IMessage<WebRtcRenegotiateRequest>, IMessage, IEquatable<WebRtcRenegotiateRequest>, IDeepCloneable<WebRtcRenegotiateRequest>, IBufferMessage
{
	private static readonly MessageParser<WebRtcRenegotiateRequest> _parser = new MessageParser<WebRtcRenegotiateRequest>(() => new WebRtcRenegotiateRequest());
	...
	public static MessageParser<WebRtcRenegotiateRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public WebRtcRenegotiateRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public WebRtcRenegotiateRequest(WebRtcRenegotiateRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public WebRtcRenegotiateRequest Clone()
	{
		return new WebRtcRenegotiateRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as WebRtcRenegotiateRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(WebRtcRenegotiateRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(WebRtcRenegotiateRequest other)
	{
		if (other == null)
		{
			return;
