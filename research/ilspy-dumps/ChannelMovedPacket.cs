...
public sealed class ChannelMovedPacket : IPacketCommunity, IPacket, IMessage<ChannelMovedPacket>, IMessage, IEquatable<ChannelMovedPacket>, IDeepCloneable<ChannelMovedPacket>, IBufferMessage
{
	private static readonly MessageParser<ChannelMovedPacket> _parser = new MessageParser<ChannelMovedPacket>(() => new ChannelMovedPacket());
	...
	public static MessageParser<ChannelMovedPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(ChannelMovedPacket packet)
	{
	...
	[GeneratedCode("protoc", null)]
	public ChannelMovedPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public ChannelMovedPacket(ChannelMovedPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public ChannelMovedPacket Clone()
	{
		return new ChannelMovedPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as ChannelMovedPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(ChannelMovedPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ChannelMovedPacket other)
	{
		if (other == null)
		{
			return;
