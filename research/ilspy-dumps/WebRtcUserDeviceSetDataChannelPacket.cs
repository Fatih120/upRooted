...
public sealed class WebRtcUserDeviceSetDataChannelPacket : IPacketWebRtc, IPacket, IMessage<WebRtcUserDeviceSetDataChannelPacket>, IMessage, IEquatable<WebRtcUserDeviceSetDataChannelPacket>, IDeepCloneable<WebRtcUserDeviceSetDataChannelPacket>, IBufferMessage
{
	private static readonly MessageParser<WebRtcUserDeviceSetDataChannelPacket> _parser = new MessageParser<WebRtcUserDeviceSetDataChannelPacket>(() => new WebRtcUserDeviceSetDataChannelPacket());
	...
	public static MessageParser<WebRtcUserDeviceSetDataChannelPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(WebRtcUserDeviceSetDataChannelPacket packet)
	{
		return new PacketContainer
		{
			WebRtcUserDeviceSetDataChannel = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public WebRtcUserDeviceSetDataChannelPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public WebRtcUserDeviceSetDataChannelPacket(WebRtcUserDeviceSetDataChannelPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public WebRtcUserDeviceSetDataChannelPacket Clone()
	{
		return new WebRtcUserDeviceSetDataChannelPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as WebRtcUserDeviceSetDataChannelPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(WebRtcUserDeviceSetDataChannelPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(WebRtcUserDeviceSetDataChannelPacket other)
	{
		if (other == null)
		{
			return;
