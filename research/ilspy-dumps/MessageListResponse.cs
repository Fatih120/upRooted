...
public sealed class MessageListResponse : IMessage<MessageListResponse>, IMessage, IEquatable<MessageListResponse>, IDeepCloneable<MessageListResponse>, IBufferMessage
{
	private static readonly MessageParser<MessageListResponse> _parser = new MessageParser<MessageListResponse>(() => new MessageListResponse());
	...
	public static MessageParser<MessageListResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public MessageListResponse(MessageListResponse other)
		: this()
	{
