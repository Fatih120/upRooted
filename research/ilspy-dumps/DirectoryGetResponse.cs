...
public sealed class DirectoryGetResponse : IMessage<DirectoryGetResponse>, IMessage, IEquatable<DirectoryGetResponse>, IDeepCloneable<DirectoryGetResponse>, IBufferMessage
{
	private static readonly MessageParser<DirectoryGetResponse> _parser = new MessageParser<DirectoryGetResponse>(() => new DirectoryGetResponse());
	...
	public static MessageParser<DirectoryGetResponse> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public DirectoryGetResponse(DirectoryGetResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public DirectoryGetResponse Clone()
	{
		return new DirectoryGetResponse(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as DirectoryGetResponse);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(DirectoryGetResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(DirectoryGetResponse other)
	{
		if (other == null)
		{
			return;
