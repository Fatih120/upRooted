...
public sealed class CommunityAppSetButtonRequest : IMessage<CommunityAppSetButtonRequest>, IMessage, IEquatable<CommunityAppSetButtonRequest>, IDeepCloneable<CommunityAppSetButtonRequest>, IBufferMessage
{
	private static readonly MessageParser<CommunityAppSetButtonRequest> _parser = new MessageParser<CommunityAppSetButtonRequest>(() => new CommunityAppSetButtonRequest());
	...
	public static MessageParser<CommunityAppSetButtonRequest> Parser => _parser;
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppSetButtonRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	public CommunityAppSetButtonRequest(CommunityAppSetButtonRequest other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public CommunityAppSetButtonRequest Clone()
	{
		return new CommunityAppSetButtonRequest(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as CommunityAppSetButtonRequest);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(CommunityAppSetButtonRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(CommunityAppSetButtonRequest other)
	{
		if (other == null)
		{
			return;
