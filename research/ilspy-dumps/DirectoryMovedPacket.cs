...
public sealed class DirectoryMovedPacket : IPacketCommunity, IPacket, IMessage<DirectoryMovedPacket>, IMessage, IEquatable<DirectoryMovedPacket>, IDeepCloneable<DirectoryMovedPacket>, IBufferMessage
{
	private static readonly MessageParser<DirectoryMovedPacket> _parser = new MessageParser<DirectoryMovedPacket>(() => new DirectoryMovedPacket());
	...
	public static MessageParser<DirectoryMovedPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(DirectoryMovedPacket packet)
	{
		return new PacketContainer
		{
			DirectoryMoved = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public DirectoryMovedPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public DirectoryMovedPacket(DirectoryMovedPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public DirectoryMovedPacket Clone()
	{
		return new DirectoryMovedPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as DirectoryMovedPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(DirectoryMovedPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(DirectoryMovedPacket other)
	{
		if (other == null)
		{
			return;
