...
public sealed class FileResponse : IMessage<FileResponse>, IMessage, IEquatable<FileResponse>, IDeepCloneable<FileResponse>, IBufferMessage
{
	private static readonly MessageParser<FileResponse> _parser = new MessageParser<FileResponse>(() => new FileResponse());
	...
	public static MessageParser<FileResponse> Parser => _parser;
	...
	public int CalculateSize()
	{
		...
		if (directoryId_ != null)
		{
			num += 2 + CodedOutputStream.ComputeMessageSize(DirectoryId);
		}
		if (containerId_ != null)
		{
			num += 2 + CodedOutputStream.ComputeMessageSize(ContainerId);
		}
		if (Sha256.Length != 0)
		{
			num += 2 + CodedOutputStream.ComputeBytesSize(Sha256);
		}
		if (_unknownFields != null)
		{
