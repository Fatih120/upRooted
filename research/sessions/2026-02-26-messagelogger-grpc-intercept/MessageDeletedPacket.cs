...
public sealed class MessageDeletedPacket : IPacketCommunity, IPacket, IMessage<MessageDeletedPacket>, IMessage, IEquatable<MessageDeletedPacket>, IDeepCloneable<MessageDeletedPacket>, IBufferMessage
{
	private static readonly MessageParser<MessageDeletedPacket> _parser = new MessageParser<MessageDeletedPacket>(() => new MessageDeletedPacket());
	...
	public static MessageParser<MessageDeletedPacket> Parser => _parser;
	...
	public static implicit operator PacketContainer(MessageDeletedPacket packet)
	{
		return new PacketContainer
		{
			MessageDeleted = packet
		};
	}

	[GeneratedCode("protoc", null)]
	public MessageDeletedPacket()
	{
	}

	[GeneratedCode("protoc", null)]
	public MessageDeletedPacket(MessageDeletedPacket other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	public MessageDeletedPacket Clone()
	{
		return new MessageDeletedPacket(this);
	}

	[GeneratedCode("protoc", null)]
	public override bool Equals(object other)
	{
		return Equals(other as MessageDeletedPacket);
	}

	[GeneratedCode("protoc", null)]
	public bool Equals(MessageDeletedPacket other)
	{
		if (other == null)
		{
			return false;
	...
	[GeneratedCode("protoc", null)]
	public void MergeFrom(MessageDeletedPacket other)
	{
		if (other == null)
		{
			return;
