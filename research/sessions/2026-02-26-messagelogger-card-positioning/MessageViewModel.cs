...
public class MessageViewModel : ViewModelBase<MessageViewModel>
{
	...
	[CompilerGenerated]
	private string? <PrimaryBadgeSvgPath>k__BackingField;

	[CompilerGenerated]
	private string? <PrimaryBadgeName>k__BackingField;
	...
	[CompilerGenerated]
	private bool <ActionBarOpen>k__BackingField;

	[CompilerGenerated]
	private bool <IsInEditMode>k__BackingField;

	[CompilerGenerated]
	private bool <IsShiftKeyPressed>k__BackingField;

	[CompilerGenerated]
	private RootMessageTextboxViewModel? <EditMessageTextboxViewModel>k__BackingField;

	[CompilerGenerated]
	private bool <IsUsernameProfilePopupOpen>k__BackingField;

	[CompilerGenerated]
	private bool <IsImageProfilePopupOpen>k__BackingField;

	[CompilerGenerated]
	private MemberProfileViewModel? <MemberProfile>k__BackingField;

	[CompilerGenerated]
	private MessageRepliesViewModel? <MessageRepliesViewModel>k__BackingField;
	...
	public bool ActionBarOpen
	{
		get
		{
			return <ActionBarOpen>k__BackingField;
		}
		set
		{
			if (!EqualityComparer<bool>.Default.Equals(<ActionBarOpen>k__BackingField, flag))
			{
				<ActionBarOpen>k__BackingField = flag;
	...
	public bool IsInEditMode
	{
		get
		{
			return <IsInEditMode>k__BackingField;
		}
		set
		{
			if (!EqualityComparer<bool>.Default.Equals(<IsInEditMode>k__BackingField, flag))
			{
				<IsInEditMode>k__BackingField = flag;
	...
	public bool IsShiftKeyPressed
	{
		get
		{
			return <IsShiftKeyPressed>k__BackingField;
		}
		set
		{
			if (!EqualityComparer<bool>.Default.Equals(<IsShiftKeyPressed>k__BackingField, flag))
			{
				<IsShiftKeyPressed>k__BackingField = flag;
	...
	public RootMessageTextboxViewModel? EditMessageTextboxViewModel
	{
		get
		{
			return <EditMessageTextboxViewModel>k__BackingField;
		}
		set
		{
			if (!EqualityComparer<RootMessageTextboxViewModel>.Default.Equals(<EditMessageTextboxViewModel>k__BackingField, rootMessageTextboxViewModel))
			{
				<EditMessageTextboxViewModel>k__BackingField = rootMessageTextboxViewModel;
	...
	public bool IsUsernameProfilePopupOpen
	{
		get
		{
			return <IsUsernameProfilePopupOpen>k__BackingField;
		}
		set
		{
			if (!EqualityComparer<bool>.Default.Equals(<IsUsernameProfilePopupOpen>k__BackingField, flag))
			{
				<IsUsernameProfilePopupOpen>k__BackingField = flag;
	...
	public bool IsImageProfilePopupOpen
	{
		get
		{
			return <IsImageProfilePopupOpen>k__BackingField;
		}
		set
		{
			if (!EqualityComparer<bool>.Default.Equals(<IsImageProfilePopupOpen>k__BackingField, flag))
			{
				<IsImageProfilePopupOpen>k__BackingField = flag;
	...
	public MessageRepliesViewModel? MessageRepliesViewModel
	{
		get
		{
			return <MessageRepliesViewModel>k__BackingField;
		}
		private set
		{
			if (!EqualityComparer<RootApp.Client.Avalonia.UI.Messages.MessageRepliesViewModel>.Default.Equals(<MessageRepliesViewModel>k__BackingField, messageRepliesViewModel))
			{
				<MessageRepliesViewModel>k__BackingField = messageRepliesViewModel;
	...
	public string? PrimaryBadgeSvgPath
	{
		...
		get
		{
			return <PrimaryBadgeSvgPath>k__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			<PrimaryBadgeSvgPath>k__BackingField = text;
		}
	}
	...
	public string? PrimaryBadgeName
	{
		...
		get
		{
			return <PrimaryBadgeName>k__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			<PrimaryBadgeName>k__BackingField = text;
		}
	}
		...
		: base((IValidator<MessageViewModel>?)null)
	{
		...
		if (Message.SenderMember != null)
		{
			...
			IObservable<IChangeSet<IViewModelBase>> observable2 = Message.ConnectPendingMedia().Transform((Func<PendingAttachment, IViewModelBase>)((PendingAttachment pending) => P_9.Create(pending, messageViewModel.Message)), transformOnRefresh: false);
		...
		{
			_mediaCacheCleanup = Message.ConnectPendingMedia().Transform((Func<PendingAttachment, IViewModelBase>)((PendingAttachment pending) => P_9.Create(pending, messageViewModel.Message)), transformOnRefresh: false).ObserveOn(AvaloniaScheduler.Instance)
				.Bind(out _media)
				.DisposeMany()
				.Subscribe();
		}
		IObservable<IChangeSet<IViewModelBase>> observable3 = Message.ConnectFiles().Transform((Func<Attachment, IViewModelBase>)((Attachment file) => P_8.Create(file)), transformOnRefresh: false);
		IObservable<IChangeSet<IViewModelBase>> observable4 = Message.ConnectPendingFiles().Transform((Func<PendingAttachment, IViewModelBase>)((PendingAttachment pending) => P_10.Create(pending, messageViewModel.Message)), transformOnRefresh: false);
		_fileCacheCleanup = observable4.Merge(observable3).ObserveOn(AvaloniaScheduler.Instance).Bind(out _files)
			.DisposeMany()
			.Subscribe();
		_reactionCacheCleanup = Message.ConnectReactions().Transform((Reaction r) => r.IsPlaceHolder ? ((IViewModelBase)P_7.Create(messageViewModel.Message)) : ((IViewModelBase)P_6.Create(r, messageViewModel.Message))).ObserveOn(AvaloniaScheduler.Instance)
			.Bind(out _reactions)
			.DisposeMany()
			.Subscribe();
	...
	public bool IsTapToReplyEnabled()
	{
		...
		global::<PrivateImplementationDetails>.InlineArrayElementRef<global::<>y__InlineArray2<string>, string>(ref <>y__InlineArray, 0) = _rootSessionAccessor.Session.UserInfoService.SessionUser.Id.ToString();
		global::<PrivateImplementationDetails>.InlineArrayElementRef<global::<>y__InlineArray2<string>, string>(ref <>y__InlineArray, 1) = "TapToReply";
		if (!localDataStore.TryGetWithPath(global::<PrivateImplementationDetails>.InlineArrayAsReadOnlySpan<global::<>y__InlineArray2<string>, string>(in <>y__InlineArray, 2), out int value))
		{
			value = 1;
		}
