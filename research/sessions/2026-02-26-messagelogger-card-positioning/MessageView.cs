...
public class MessageView : UserControl, ISelectableMessage
{
	...
	private class XamlClosure_178
	{
		...
		{
			CompiledAvaloniaXaml.XamlIlContext.Context<MessageView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<MessageView>(P_0, new object[1] { !AvaloniaResources.NamespaceInfo:/UI/Messages/MessageView.axaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Messages/MessageView.axaml");
			if (P_0 != null)
			{
	...
	private DateTimeOffset? DateTime
	{
		...
		set
		{
			<DateTime>k__BackingField = dateTimeOffset;
		}
	}
	...
	private void Hook()
	{
		...
		base.Cursor = (messageViewModel.IsTapToReplyEnabled() ? new Cursor(StandardCursorType.Hand) : global::Avalonia.Input.Cursor.Default);
		if (_communityMember != null)
		{
			updateMemberColor();
		}
	...
	private void onMessageBackgroundBorderContextRequested(object? sender, ContextRequestedEventArgs e)
	{
		...
		{
			CHyperlink link = FindDescendants<CHyperlink>(cTextBlock).FirstOrDefault((CHyperlink l) => l.Classes.Contains(":pointerover"));
	...
	[CompilerGenerated]
	private unsafe static void !XamlIlPopulate(IServiceProvider P_0, MessageView P_1)
	{
		CompiledAvaloniaXaml.XamlIlContext.Context<MessageView> context = new CompiledAvaloniaXaml.XamlIlContext.Context<MessageView>(P_0, new object[1] { !AvaloniaResources.NamespaceInfo:/UI/Messages/MessageView.axaml.Singleton }, "avares://RootApp.Client.Avalonia/UI/Messages/MessageView.axaml")
		{
			RootObject = P_1,
		...
		CompiledBindingExtension obj2 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.DeletedAt!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build())
		{
		...
		((ResourceDictionary)P_1.Resources).AddDeferred((object)"DateDividerConverter", XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<object>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_178.Build_1), context));
		((ResourceDictionary)P_1.Resources).AddDeferred((object)"MessageDateConverter", XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<object>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_178.Build_2), context));
		((ResourceDictionary)P_1.Resources).AddDeferred((object)"MessageTimeConverter", XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<object>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_178.Build_3), context));
		((ResourceDictionary)P_1.Resources).AddDeferred((object)"PlaceholderOpacityConverter", XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<object>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_178.Build_4), context));
		((ResourceDictionary)P_1.Resources).AddDeferred((object)"FullDateTimeConverter", XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<object>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_178.Build_5), context));
		...
		CompiledBindingExtension obj3 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
		...
		CompiledBindingExtension compiledBindingExtension3 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.EnterEditModeCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		{
			Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.IsMyMessage!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()
		};
		...
		{
			Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.IsSystemMessage!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
				.Build()
		};
		context.ProvideTargetProperty = CompiledAvaloniaXaml.XamlIlHelpers.Avalonia.Data.MultiBinding,Avalonia.Markup.Bindings!Property();
		...
		{
			Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.IsPlaceholder!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
				.Build()
		};
		context.ProvideTargetProperty = CompiledAvaloniaXaml.XamlIlHelpers.Avalonia.Data.MultiBinding,Avalonia.Markup.Bindings!Property();
		...
		CompiledBindingExtension compiledBindingExtension5 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.ReplyToMessageCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = MenuItem.CommandProperty;
		...
		CompiledBindingExtension obj10 = new CompiledBindingExtension
		{
			Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.MessageContainer!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainer,RootApp.Client.CoreDomain.LocalChannelPermission!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
				.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Community.LocalChannelPermission,RootApp.Client.CoreDomain.ChannelCreateMessage!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
				.Build()
		};
		context.ProvideTargetProperty = CompiledAvaloniaXaml.XamlIlHelpers.Avalonia.Data.MultiBinding,Avalonia.Markup.Bindings!Property();
		...
		compiledBindingExtension7.Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		CompiledBindingExtension compiledBindingExtension8 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.MessageContainer!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainer,RootApp.Client.CoreDomain.LocalChannelPermission!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
		...
		CompiledBindingExtension compiledBindingExtension10 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.PinMessageCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = MenuItem.CommandProperty;
		...
		compiledBindingExtension12.Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.MessageContainer!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainer,RootApp.Client.CoreDomain.LocalChannelPermission!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Community.LocalChannelPermission,RootApp.Client.CoreDomain.ChannelManagePinnedMessages!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		CompiledBindingExtension compiledBindingExtension15 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.DeleteMessageCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = MenuItem.CommandProperty;
		...
		{
			Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.MessageContainer!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainer,RootApp.Client.CoreDomain.LocalChannelPermission!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
				.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Community.LocalChannelPermission,RootApp.Client.CoreDomain.ChannelDeleteMessageOther!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
				.Build()
		};
		context.ProvideTargetProperty = CompiledAvaloniaXaml.XamlIlHelpers.Avalonia.Data.MultiBinding,Avalonia.Markup.Bindings!Property();
		...
		CompiledBindingExtension compiledBindingExtension17 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.DeveloperModeEnabled!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		CompiledBindingExtension compiledBindingExtension19 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.CopyMessageIdCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = MenuItem.CommandProperty;
		...
		CompiledBindingExtension compiledBindingExtension21 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.DeveloperModeEnabled!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		CompiledBindingExtension compiledBindingExtension23 = (compiledBindingExtension24 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.IsPlaceholder!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()));
		...
		CompiledBindingExtension compiledBindingExtension27 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.ShowNewDivider!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock5, obj17);
		...
		CompiledBindingExtension compiledBindingExtension29 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.ShowDateDivider!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		CompiledBindingExtension compiledBindingExtension31 = (compiledBindingExtension24 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SentAtUtc!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()));
		context.PushParent(compiledBindingExtension24);
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock9, obj19);
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_25(border5, obj20);
		Panel panel2;
		...
		global::Avalonia.Controls.Controls children10 = panel4.Children;
		Border border7;
		...
		global::Avalonia.Controls.Controls children11 = panel4.Children;
		Grid grid15;
		...
		CompiledBindingExtension compiledBindingExtension34 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.MessageRepliesViewModel!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_4(contentControl5, compiledBindingExtension35);
		...
		{
			Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.HasMessageReply!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()
		};
		context.ProvideTargetProperty = CompiledAvaloniaXaml.XamlIlHelpers.Avalonia.Data.MultiBinding,Avalonia.Markup.Bindings!Property();
		...
		compiledBindingExtension36.Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		global::Avalonia.Controls.Controls children13 = grid17.Children;
		Button button2;
		...
		{
			Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.ShowUserProfile!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()
		};
		context.ProvideTargetProperty = CompiledAvaloniaXaml.XamlIlHelpers.Avalonia.Data.MultiBinding,Avalonia.Markup.Bindings!Property();
		...
		compiledBindingExtension37.Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		CompiledBindingExtension obj25 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.UserContextMenu!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.System.Lazy`1,System.Runtime.Value!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true).Build())
		{
			FallbackValue = null
		};
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_22(userContextMenuView2, compiledBindingExtension38);
		context.PopParent();
		...
		CompiledBindingExtension compiledBindingExtension39 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.IsImageProfilePopupOpen!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		CompiledBindingExtension compiledBindingExtension41 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.MemberProfile!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = ContentControl.ContentProperty;
		CompiledBindingExtension compiledBindingExtension42 = compiledBindingExtension41.ProvideValue(context);
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_4(contentControl9, compiledBindingExtension42);
		context.PopParent();
		...
		CompiledBindingExtension compiledBindingExtension43 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.ProfilePictureAsyncBitmapWrapper!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).StreamTask<BitmapWrapper>().Build());
		...
		global::Avalonia.Controls.Controls children14 = grid17.Children;
		...
		CompiledBindingExtension compiledBindingExtension45 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.IsSystemMessage!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		global::Avalonia.Controls.Controls children15 = grid17.Children;
		...
		CompiledBindingExtension compiledBindingExtension47 = (compiledBindingExtension24 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SentAtUtc!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()));
		context.PushParent(compiledBindingExtension24);
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock13, obj27);
		...
		global::Avalonia.Controls.Controls children16 = grid17.Children;
		...
		CompiledBindingExtension compiledBindingExtension50 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.EditMessageTextboxViewModel!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = ContentControl.ContentProperty;
		CompiledBindingExtension compiledBindingExtension51 = compiledBindingExtension50.ProvideValue(context);
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_4(contentControl13, compiledBindingExtension51);
		context.PopParent();
		((ISupportInitialize)contentControl12).EndInit();
		global::Avalonia.Controls.Controls children17 = grid17.Children;
		Grid grid19;
		...
		CompiledBindingExtension compiledBindingExtension52 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.IsInEditMode!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		global::Avalonia.Controls.Controls children18 = grid21.Children;
		...
		CompiledBindingExtension obj32 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_4(rootLinkButton5, compiledBindingExtension54);
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_3(rootLinkButton5, obj33);
		...
		compiledBindingExtension55.Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		CompiledBindingExtension obj36 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.UserContextMenu!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.System.Lazy`1,System.Runtime.Value!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true).Build())
		{
			FallbackValue = null
		};
		context.ProvideTargetProperty = UserContextMenuView.DataContextProperty;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_22(userContextMenuView3, compiledBindingExtension56);
		context.PopParent();
		...
		CompiledBindingExtension compiledBindingExtension57 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.IsUsernameProfilePopupOpen!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = RootFlyout.IsPopupOpenProperty;
		...
		CompiledBindingExtension compiledBindingExtension59 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.MemberProfile!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = ContentControl.ContentProperty;
		CompiledBindingExtension compiledBindingExtension60 = compiledBindingExtension59.ProvideValue(context);
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_4(contentControl17, compiledBindingExtension60);
		context.PopParent();
		...
		global::Avalonia.Controls.Controls children19 = grid21.Children;
		...
		CompiledBindingExtension compiledBindingExtension61 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.PrimaryBadgeSvgPath!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		compiledBindingExtension63.Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		compiledBindingExtension64.Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.PrimaryBadgeSvgPath!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build();
		...
		global::Avalonia.Controls.Controls children20 = grid25.Children;
		...
		CompiledBindingExtension compiledBindingExtension65 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.PrimaryBadgeSvgPath!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = RootSvgImage.SvgPathProperty;
		...
		global::Avalonia.Controls.Controls children21 = grid25.Children;
		...
		global::Avalonia.Controls.Controls children22 = stackPanel5.Children;
		...
		CompiledBindingExtension compiledBindingExtension67 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.PrimaryBadgeName!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = TextBlock.TextProperty;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock17, obj39);
		...
		global::Avalonia.Controls.Controls children23 = grid21.Children;
		Border border9;
		...
		compiledBindingExtension69.Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.IsApp!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock21, obj42);
		...
		CompiledBindingExtension compiledBindingExtension70 = (compiledBindingExtension24 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SentAtUtc!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()));
		context.PushParent(compiledBindingExtension24);
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock25, obj44);
		...
		compiledBindingExtension73.Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		global::Avalonia.Controls.Controls children25 = grid21.Children;
		...
		CompiledBindingExtension compiledBindingExtension74 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.MarkdownEngine!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		CompiledBindingExtension compiledBindingExtension76 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.MessageContent!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		CompiledBindingExtension obj47 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build())
		{
		...
		global::Avalonia.Controls.Controls children26 = grid21.Children;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock29, obj48);
		...
		CompiledBindingExtension obj49 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build())
		{
			FallbackValue = "False"
		...
		global::Avalonia.Controls.Controls children27 = grid21.Children;
		...
		CompiledBindingExtension compiledBindingExtension80 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Links!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		compiledBindingExtension82.Path = new CompiledBindingPathBuilder(1).Not().Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Links!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.System.Collections.ObjectModel.ReadOnlyCollection`1,System.Runtime.Count_91!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Build();
		...
		compiledBindingExtension83.Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		{
			Content = XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<Control>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_178.Build_6), context)
		};
		context.PopParent();
		((ISupportInitialize)itemsControl3).EndInit();
		global::Avalonia.Controls.Controls children28 = grid21.Children;
		...
		CompiledBindingExtension compiledBindingExtension84 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Media!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = ItemsControl.ItemsSourceProperty;
		...
		compiledBindingExtension86.Path = new CompiledBindingPathBuilder(1).Not().Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Media!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.System.Collections.ObjectModel.ReadOnlyCollection`1,System.Runtime.Count_84!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Build();
		...
		{
			Content = XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<Control>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_178.Build_7), context)
		};
		context.PopParent();
		((ISupportInitialize)itemsControl8).EndInit();
		global::Avalonia.Controls.Controls children29 = grid21.Children;
		...
		CompiledBindingExtension compiledBindingExtension88 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Files!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = ItemsControl.ItemsSourceProperty;
		...
		compiledBindingExtension90.Path = new CompiledBindingPathBuilder(1).Not().Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Files!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.System.Collections.ObjectModel.ReadOnlyCollection`1,System.Runtime.Count_84!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Build();
		...
		compiledBindingExtension91.Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		{
			Content = XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<Control>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_178.Build_8), context)
		};
		context.PopParent();
		((ISupportInitialize)itemsControl12).EndInit();
		global::Avalonia.Controls.Controls children30 = grid21.Children;
		...
		compiledBindingExtension92.Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.EditedAt!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build();
		...
		compiledBindingExtension93.Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.PinnedAt!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build();
		...
		global::Avalonia.Controls.Controls children31 = stackPanel9.Children;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock33, obj54);
		textBlock33.FontWeight = (FontWeight)450;
		StyledProperty<bool> isVisibleProperty28 = Visual.IsVisibleProperty;
		CompiledBindingExtension obj55 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.EditedAt!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build())
		{
		...
		CompiledBindingExtension compiledBindingExtension95 = (compiledBindingExtension24 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.EditedAt!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()));
		context.PushParent(compiledBindingExtension24);
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock37, obj57);
		...
		global::Avalonia.Controls.Controls children32 = stackPanel9.Children;
		...
		CompiledBindingExtension obj58 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.PinnedAt!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build())
		{
			Converter = ObjectConverters.IsNotNull
		};
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock41, obj59);
		...
		CompiledBindingExtension compiledBindingExtension99 = (compiledBindingExtension24 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.PinnedAt!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()));
		context.PushParent(compiledBindingExtension24);
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock45, obj61);
		...
		global::Avalonia.Controls.Controls children33 = grid21.Children;
		...
		CompiledBindingExtension compiledBindingExtension102 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Reactions!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = ItemsControl.ItemsSourceProperty;
		...
		CompiledBindingExtension compiledBindingExtension104 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Not().Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Reactions!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.System.Collections.ObjectModel.ReadOnlyCollection`1,System.Runtime.Count_84!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Build());
		...
		{
			Content = XamlIlRuntimeHelpers.DeferredTransformationFactoryV3<Control>((nint)(delegate*<IServiceProvider, object>)(&XamlClosure_178.Build_9), context)
		};
		context.PopParent();
		((ISupportInitialize)itemsControl16).EndInit();
		global::Avalonia.Controls.Controls children34 = grid21.Children;
		...
		CompiledBindingExtension compiledBindingExtension106 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.FailedToSend!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		global::Avalonia.Controls.Controls children35 = stackPanel13.Children;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock49, obj62);
		...
		global::Avalonia.Controls.Controls children36 = stackPanel13.Children;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_3(rootLinkButton9, obj63);
		...
		CompiledBindingExtension compiledBindingExtension108 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.RetrySendCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		...
		global::Avalonia.Controls.Controls children37 = grid17.Children;
		...
		global::Avalonia.Controls.Controls children38 = wrapPanel4.Children;
		...
		CompiledBindingExtension compiledBindingExtension110 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.MessageContainer!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainer,RootApp.Client.CoreDomain.LocalChannelPermission!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Community.LocalChannelPermission,RootApp.Client.CoreDomain.ChannelCreateMessageReaction!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build());
		context.ProvideTargetProperty = Visual.IsVisibleProperty;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock53, obj64);
		...
		CompiledBindingExtension compiledBindingExtension112 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.EmojiPickerViewModel!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = ContentControl.ContentProperty;
		CompiledBindingExtension compiledBindingExtension113 = compiledBindingExtension112.ProvideValue(context);
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_4(contentControl21, compiledBindingExtension113);
		context.PopParent();
		...
		global::Avalonia.Controls.Controls children39 = wrapPanel4.Children;
		...
		CompiledBindingExtension compiledBindingExtension114 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.ReplyToMessageCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Button.CommandProperty;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock57, obj65);
		...
		compiledBindingExtension116.Path = new CompiledBindingPathBuilder(1).Not().Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.Message!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.Message,RootApp.Client.CoreDomain.SenderMember!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.Messages.IMessageContainerMember,RootApp.Client.CoreDomain.GlobalUser!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor, true)
			.Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.CoreDomain.Models.User.GlobalUser,RootApp.Client.CoreDomain.IsBlocked!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor)
			.Build();
		...
		global::Avalonia.Controls.Controls children40 = wrapPanel4.Children;
		...
		CompiledBindingExtension compiledBindingExtension117 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.EnterEditModeCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Button.CommandProperty;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock61, obj69);
		...
		global::Avalonia.Controls.Controls children41 = wrapPanel4.Children;
		...
		CompiledBindingExtension compiledBindingExtension119 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.PinMessageCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Button.CommandProperty;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock65, obj74);
		...
		global::Avalonia.Controls.Controls children42 = wrapPanel4.Children;
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_25(rootSvgButton21, obj77);
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock69, obj78);
		...
		global::Avalonia.Controls.Controls children43 = wrapPanel4.Children;
		...
		CompiledBindingExtension compiledBindingExtension122 = new CompiledBindingExtension(new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.DirectDeleteMessageCommand!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build());
		context.ProvideTargetProperty = Button.CommandProperty;
		...
		{
			Path = new CompiledBindingPathBuilder(1).Property(CompiledAvaloniaXaml.XamlIlHelpers.RootApp.Client.Avalonia.UI.Messages.MessageViewModel,RootApp.Client.Avalonia.IsShiftKeyPressed!Property(), PropertyInfoAccessorFactory.CreateInpcPropertyAccessor).Build()
		};
		context.ProvideTargetProperty = CompiledAvaloniaXaml.XamlIlHelpers.Avalonia.Data.MultiBinding,Avalonia.Markup.Bindings!Property();
		...
		context.ProvideTargetProperty = null;
		CompiledAvaloniaXaml.XamlDynamicSetters.<>XamlDynamicSetter_1(textBlock73, obj84);
	...
	[CompilerGenerated]
	private static void !XamlIlPopulateTrampoline(MessageView P_0)
	{
