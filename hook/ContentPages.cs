    ...
    private static void EnsureStaticInit()
    {
        ...
        try
        {
            KnownPlugins = new PluginInfo[]
            {
                ...
                new() { Id = "clear-urls", DisplayName = "ClearURLs", Version = "0.5.0-rc",
                ...
                new() { Id = "message-logger", DisplayName = "MessageLogger", Version = "0.5.0-rc",
                ...
                new() { Id = "content-filter", DisplayName = "ContentFilter", Version = "0.5.0-rc",
                    ...
                    DefaultEnabled = false, HasSettings = true, TestingStatus = 0 },
                new() { Id = "rootcord", DisplayName = "Rootcord", Version = "0.5.0-rc",
                ...
                new() { Id = "recon-logger", DisplayName = "ReconLogger", Version = "0.5.0-rc",
                ...
                new() { Id = "translate", DisplayName = "Translate", Version = "0.5.0-rc",
                    ...
                    DefaultEnabled = false, HasSettings = true, TestingStatus = 0 },
                new() { Id = "who-reacted", DisplayName = "WhoReacted", Version = "0.5.0-rc",
