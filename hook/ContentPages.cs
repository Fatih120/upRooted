...
internal static class ContentPages
{
    ...
    private static void EnsureStaticInit()
    {
        ...
        try
        {
            ...
            {
                new() { Id = "sentry-blocker", DisplayName = "SentryBlocker", Version = "0.5.1",
                ...
                new() { Id = "themes", DisplayName = "ThemeEngine", Version = "0.5.1",
                    ...
                    DefaultEnabled = false, HasSettings = false, TestingStatus = 3 },
                new() { Id = "link-embeds", DisplayName = "LinkEmbeds", Version = "0.5.1",
                ...
                new() { Id = "clear-urls", DisplayName = "ClearURLs", Version = "0.5.1",
                    ...
                    DefaultEnabled = false, HasSettings = false, TestingStatus = 3 },
                new() { Id = "message-logger", DisplayName = "MessageLogger", Version = "0.5.1",
                ...
                new() { Id = "silent-typing", DisplayName = "SilentTyping", Version = "0.5.1",
                ...
                new() { Id = "content-filter", DisplayName = "ContentFilter", Version = "0.5.1",
                ...
                new() { Id = "translate", DisplayName = "Translate", Version = "0.5.1",
                    ...
                    DefaultEnabled = false, HasSettings = true, TestingStatus = 0 },
                new() { Id = "who-reacted", DisplayName = "WhoReacted", Version = "0.5.1",
