...
### Release Artifacts (v0.2.1)
| Platform | Artifact | CI Workflow |
|----------|----------|-------------|
| Windows | `Uprooted-0.2.1.exe` | build-installer.yml |
| Linux (Debian/Ubuntu) | `uprooted_0.2.1_amd64.deb` | build-linux.yml |
| Linux (portable) | `Uprooted-0.2.1.AppImage` | build-linux.yml |
| Arch Linux | `uprooted-bin-0.2.1-1-x86_64.pkg.tar.zst` | build-linux.yml (build-arch job) |
