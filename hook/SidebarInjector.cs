...
internal class SidebarInjector
{
    ...
    private object? _versionTextBlock;                   // "Uprooted 0.4.1" TextBlock in version box
    ...
    /// <summary>
    /// Inject "Uprooted 0.4.1" into the grey version info box at the bottom of the sidebar.
    ...
    private void InjectVersionText()
    {
        ...
        try
        {
            ...
            // Create "Uprooted 0.4.1" TextBlock matching existing style (FontSize=10, Fg=#66f2f2f2)
